...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(e,t,n){let r=new Float32Array(qa),i=new V(0,1,0);return new Mi({name:`SphericalGaussianBlur`,defines:{n:qa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:uo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(){return new Mi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:uo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(){return new Mi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:uo(),fragmentShader:`
...
`)}var Ls={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Rs(e,t){let n=Ls[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var zs=new V;function Bs(){return It.getLuminanceCoefficients(zs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${zs.x.toFixed(4)}, ${zs.y.toFixed(4)}, ${zs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ks(i,i.VERTEX_SHADER,y),S=ks(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Fs(i,x,`vertex`),n=Fs(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,Vc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new mi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Mi({vertexShader:zc,fragmentShader:Bc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new W(new xi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Hc=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Vc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,te=null,O=new da;O.viewport=new qt;let ne=new da;ne.viewport=new qt;let k=[O,ne],A=new va,re=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getHandSpace()};function j(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,j),r.removeEventListener(`selectstart`,j),r.removeEventListener(`selectend`,j),r.removeEventListener(`squeeze`,j),r.removeEventListener(`squeezestart`,j),r.removeEventListener(`squeezeend`,j),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,ie=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,j),r.addEventListener(`selectstart`,j),r.addEventListener(`selectend`,j),r.addEventListener(`squeeze`,j),r.addEventListener(`squeezestart`,j),r.addEventListener(`squeezeend`,j),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Yt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new fi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Yt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let se=new V,ce=new V;function le(e,t,n){se.setFromMatrixPosition(t.matrixWorld),ce.setFromMatrixPosition(n.matrixWorld);let r=se.distanceTo(ce),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ue(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||ie!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,ie=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;ue(A,i);for(let e=0;e<a.length;e++)ue(a[e],i);a.length===2?le(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),de(e,A,i)};function de(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let M=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new da,o.layers.enable(n),o.viewport=new qt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new mi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}M&&M(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new Pa;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){M=e},this.dispose=function(){}}},Uc=new Qt,Wc=new H;Wc.set(-1,0,0,0,1,0,0,0,1);function Gc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Oi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Uc.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Wc),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Kc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var qc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Jc=null;function Yc(){return Jc===null&&(Jc=new ti(qc,16,16,te,g),Jc.name=`DFG_LUT`,Jc.minFilter=o,Jc.magFilter=o,Jc.wrapS=t,Jc.wrapT=t,Jc.generateMipmaps=!1,Jc.needsUpdate=!0),Jc}var Xc=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new V,te=null,k=null,A=[],re=[],ie=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ae=!1,oe=null,se=null,ce=null,le=null;this._outputColorSpace=Be;let ue=0,de=0,M=null,fe=-1,pe=null,me=new qt,he=new qt,ge=null,_e=new Nn(0),ve=0,ye=t.width,be=t.height,xe=1,Se=null,Ce=null,we=new qt(0,0,ye,be),Te=new qt(0,0,ye,be),Ee=!1,De=new li,Oe=!1,ke=!1,Ae=new Qt,je=new V,Me=new qt,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pe=!1;function Fe(){return M===null?xe:1}let N=n;function Ie(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,lt,!1),t.addEventListener(`webglcontextrestored`,ut,!1),t.addEventListener(`webglcontextcreationerror`,dt,!1),N===null){let t=`webgl2`;if(N=Ie(t,e),N===null)throw Ie(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Le,Re,P,ze,F,I,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at,ot,st;function z(){Le=new mo(N),Le.init(),at=new Rc(N,Le),Re=new Ua(N,Le,e,at),P=new Ic(N,Le),Re.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),se=N.createFramebuffer(),ce=N.createFramebuffer(),le=N.createFramebuffer(),ze=new _o(N),F=new gc,I=new Lc(N,Le,P,F,Re,at,ze),Ve=new po(j),He=new Fa(N),ot=new Va(N,He),Ue=new ho(N,He,ze,ot),We=new yo(N,Ue,He,ot,ze),nt=new vo(N,Re,I),Qe=new Wa(F),Ke=new hc(j,Ve,Le,Re,ot,Qe),qe=new Gc(j,F),Je=new bc,Xe=new Dc(Le),tt=new Ba(j,Ve,P,We,x,s),$e=new Fc(j,We,Re),st=new Kc(N,ze,Re,P),rt=new Ha(N,Le,ze),it=new go(N,Le,ze),ze.programs=Ke.programs,j.capabilities=Re,j.extensions=Le,j.properties=F,j.renderLists=Je,j.shadowMap=$e,j.state=P,j.info=ze}z(),S!==1009&&(ie=new xo(S,t.width,t.height,o,r,i));let ct=new Hc(j,N);this.xr=ct,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return xe},this.setPixelRatio=function(e){e!==void 0&&(xe=e,this.setSize(ye,be,!1))},this.getSize=function(e){return e.set(ye,be)},this.setSize=function(e,n,r=!0){if(ct.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ye=e,be=n,t.width=Math.floor(e*xe),t.height=Math.floor(n*xe),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ie!==null&&ie.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ye*xe,be*xe).floor()},this.setDrawingBufferSize=function(e,n,r){ye=e,be=n,xe=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){R(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ie.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(me)},this.getViewport=function(e){return e.copy(we)},this.setViewport=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),P.viewport(me.copy(we).multiplyScalar(xe).round())},this.getScissor=function(e){return e.copy(Te)},this.setScissor=function(e,t,n,r){e.isVector4?Te.set(e.x,e.y,e.z,e.w):Te.set(e,t,n,r),P.scissor(he.copy(Te).multiplyScalar(xe).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(e){P.setScissorTest(Ee=e)},this.setOpaqueSort=function(e){Se=e},this.setTransparentSort=function(e){Ce=e},this.getClearColor=function(e){return e.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=tt.getClearColor(),r=tt.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),oe=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,lt,!1),t.removeEventListener(`webglcontextrestored`,ut,!1),t.removeEventListener(`webglcontextcreationerror`,dt,!1),tt.dispose(),Je.dispose(),Xe.dispose(),F.dispose(),Ve.dispose(),We.dispose(),ot.dispose(),st.dispose(),Ke.dispose(),ct.dispose(),ct.removeEventListener(`sessionstart`,vt),ct.removeEventListener(`sessionend`,yt),bt.stop()};function lt(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ae=!0}function ut(){Ze(`WebGLRenderer: Context Restored.`),ae=!1;let e=ze.autoReset,t=$e.enabled,n=$e.autoUpdate,r=$e.needsUpdate,i=$e.type;z(),ze.autoReset=e,$e.enabled=t,$e.autoUpdate=n,$e.needsUpdate=r,$e.type=i}function dt(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ft(e){let t=e.target;t.removeEventListener(`dispose`,ft),pt(t)}function pt(e){mt(e),F.remove(e)}function mt(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){Ke.releaseProgram(e)}),e.isShaderMaterial&&Ke.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ne);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=kt(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ue.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;ot.setup(i,r,s,n,c);let h,g=rt;if(c!==null&&(h=He.get(c),g=it,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Fe()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Fe()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh)if(Le.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?He.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ht(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Et(e,t,n),e.side=0,e.needsUpdate=!0,Et(e,t,n),e.side=2):Et(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Xe.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ht(a,n,e),r.add(a)}else ht(t,n,e),r.add(t)}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Le.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let gt=null;function _t(e){gt&&gt(e)}function vt(){bt.stop()}function yt(){bt.start()}let bt=new Pa;bt.setAnimationLoop(_t),typeof self<`u`&&bt.setContext(self),this.setAnimationLoop=function(e){gt=e,ct.setAnimationLoop(e),e===null?bt.stop():bt.start()},ct.addEventListener(`sessionstart`,vt),ct.addEventListener(`sessionend`,yt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ae===!0)return;oe!==null&&oe.renderStart(e,t);let n=ct.enabled===!0&&ct.isPresenting===!0,r=ie!==null&&(M===null||n)&&ie.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(ie===null||ie.isCompositing()===!1)&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(t),t=ct.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),k=Xe.get(e,re.length),k.init(t),k.state.textureUnits=I.getTextureUnits(),re.push(k),Ae.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),De.setFromProjectionMatrix(Ae,Ge,t.reversedDepth),ke=this.localClippingEnabled,Oe=Qe.init(this.clippingPlanes,ke),te=Je.get(e,A.length),te.init(),A.push(te),ct.enabled===!0&&ct.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&xt(e,t,-1/0,j.sortObjects)}xt(e,t,0,j.sortObjects),te.finish(),j.sortObjects===!0&&te.sort(Se,Ce,t.reversedDepth),Pe=ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1,Pe&&tt.addToRenderList(te,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Oe===!0&&Qe.beginShadows();let i=k.state.shadowsArray;if($e.render(i,e,t),Oe===!0&&Qe.endShadows(),(r&&ie.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];Ct(n,r,e,a)}Pe&&tt.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];St(te,e,n,n.viewport)}}else r.length>0&&Ct(n,r,e,t),Pe&&tt.render(e),St(te,e,t)}M!==null&&de===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&ie.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),ot.resetDefaultState(),fe=-1,pe=null,re.pop(),re.length>0?(k=re[re.length-1],I.setTextureUnits(k.state.textureUnits),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,oe!==null&&oe.renderEnd()};function xt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||De.intersectsSprite(e)){r&&Me.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ae);let t=We.update(e),i=e.material;i.visible&&te.push(e,t,i,n,Me.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||De.intersectsObject(e))){let t=We.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Me.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Me.copy(e.boundingSphere.center)),Me.applyMatrix4(e.matrixWorld).applyMatrix4(Ae)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,Me.z,o)}}else i.visible&&te.push(e,t,i,n,Me.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)xt(i[e],t,n,r)}function St(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,n),r&&P.viewport(me.copy(r)),i.length>0&&wt(i,t,n),a.length>0&&wt(a,t,n),o.length>0&&wt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function Ct(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Le.has(`EXT_color_buffer_half_float`)||Le.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Yt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Re.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:It.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||me;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(_e),ve=j.getClearAlpha(),ve<1&&j.setClearColor(16777215,.5),j.clear(),Pe&&tt.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,r),wt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Le.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Tt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(_e,ve),p!==void 0&&(r.viewport=p),j.toneMapping=f}function wt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Tt(o,t,n,s,l,c)}}function Tt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function Et(e,t,n){t.isScene!==!0&&(t=Ne);let r=F.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ke.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ke.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ve.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ft),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Ot(e,s),d}else s.uniforms=Ke.getUniforms(e),oe!==null&&e.isNodeMaterial&&oe.build(e,n,s),e.onBeforeCompile(s,j),d=Ke.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Qe.uniform),Ot(e,s),r.needsLights=jt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Dt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Os.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Ot(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function B(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function kt(e,t,n,r,i){t.isScene!==!0&&(t=Ne),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:It.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ve.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=k.state.lights;if(Oe===!0&&(ke===!0||e!==pe)){let t=e===pe&&r.id===fe;Qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Qe.numPlanes||v.numIntersection!==Qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Et(r,t,i),oe&&r.isNodeMaterial&&oe.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==fe&&(fe=r.id,C=!0),v.needsLights){let e=B(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||pe!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,je.setFromMatrixPosition(e.matrixWorld)),Re.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),pe!==e&&(pe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&nt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Yc()),C){if(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&At(E,w),a&&r.fog===!0&&qe.refreshFogUniforms(E,a),qe.refreshMaterialUniforms(E,r,xe,be,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Os.upload(N,Dt(v),E,I)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Os.upload(N,Dt(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];st.update(n,x),st.bind(n,x)}}return x}function At(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function jt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ue},this.getActiveMipmapLevel=function(){return de},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){M=e,ue=t,de=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest,P.viewport(me),P.scissor(he),P.setScissorTest(ge),fe=-1;return}else if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest}else me.copy(we).multiplyScalar(xe).floor(),he.copy(Te).multiplyScalar(xe).floor(),ge=Ee;if(n!==0&&(r=se),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(me),P.scissor(he),P.setScissorTest(ge),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}fe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Re.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,at.convert(c),at.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Re.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,at.convert(l),at.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await et(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=at.convert(t.format),_=at.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),P.activeTexture(N.TEXTURE0),P.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(N.UNPACK_ROW_LENGTH),b=P.getParameter(N.UNPACK_IMAGE_HEIGHT),x=P.getParameter(N.UNPACK_SKIP_PIXELS),S=P.getParameter(N.UNPACK_SKIP_ROWS),C=P.getParameter(N.UNPACK_SKIP_IMAGES);P.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(N.UNPACK_SKIP_PIXELS,l),P.pixelStorei(N.UNPACK_SKIP_ROWS,u),P.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,ce),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,le);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(N.UNPACK_ROW_LENGTH,y),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(N.UNPACK_SKIP_PIXELS,x),P.pixelStorei(N.UNPACK_SKIP_ROWS,S),P.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ue=0,de=0,M=null,P.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=It._getDrawingBufferColorSpace(e),t.unpackColorSpace=It._getUnpackColorSpace()}};function Zc(t=256,n=256,r=`#a5502f`){let i=document.createElement(`canvas`);i.width=t,i.height=n;let a=i.getContext(`2d`);a.fillStyle=`#8a3f24`,a.fillRect(0,0,t,n);let o=[`#a5502f`,`#b05a36`,`#9a4829`,`#ad5433`,`#a24d2c`,`#b7623c`];for(let e=0,r=0;r<n;e++,r+=14){let n=e%2*(32/2);for(let e=-32;e<t+32;e+=32)a.fillStyle=o[Math.floor(Math.random()*o.length)],a.fillRect(e+n+2,r+2,28,10)}let s=new di(i);return s.wrapS=s.wrapT=e,s.colorSpace=Be,s.anisotropy=4,s}function Qc(){return Zc(128,128)}var J={brickRedA:new G({color:10504748}),brickRedB:new G({color:9256742}),brickTan:new G({color:13150328}),cream:new G({color:15260868}),stoneGray:new G({color:10130570}),trimWhite:new G({color:16052196}),trimDark:new G({color:4012598}),glass:new G({color:6258064}),glassWarm:new G({color:15255944,emissive:6704670}),ironBlack:new G({color:2367775}),woodBrown:new G({color:7031343}),woodLight:new G({color:10252872}),leafGreen:new G({color:5078074}),leafGreenB:new G({color:6263111}),leafFall:new G({color:13208110}),trunk:new G({color:6047282}),awningRed:new G({color:11549232}),awningGreen:new G({color:3039043}),awningBlue:new G({color:3100019}),awningBurg:new G({color:7218230}),umbRed:new G({color:12729134,side:2}),umbGreen:new G({color:3107663,side:2}),umbCream:new G({color:15327951,side:2}),orange:new G({color:15233578}),safetyStripe:new G({color:16117990}),cardboard:new G({color:11570526}),planterClay:new G({color:8211253}),bikeBlue:new G({color:3829413}),chalkWhite:new G({color:15919832}),lampGlow:new G({color:16773832,emissive:16771496,emissiveIntensity:.9}),glassClear:new G({color:12113118,transparent:!0,opacity:.35}),interiorGlow:new G({color:15980960,emissive:10123320,emissiveIntensity:.55}),interiorDark:new G({color:3024416}),interiorProp:new G({color:4536880}),doorGreen:new G({color:3039043}),doorRed:new G({color:9318183}),doorBlue:new G({color:3100019}),asphalt:new G({color:4999752}),curb:new G({color:12893355}),boulder:new G({color:7227965}),boulderB:new G({color:8215113}),bronze:new G({color:5200458}),bronzeDark:new G({color:4015676}),granite:new G({color:11907237}),flag:[new G({color:13777723,side:2}),new G({color:15245354,side:2}),new G({color:3051355,side:2}),new G({color:3829413,side:2}),new G({color:10181046,side:2}),new G({color:4241604,side:2})]};J.brickTexA=new G({map:Qc()});var $c=new hi(1,1,1),el=new _i(1,1,1,8),tl=new Si(1,8,6),nl=new bi(1,1),rl=new vi(1,1,8);function Y(e,t,n,r,i=0,a=0,o=0){let s=new W($c,r);return s.scale.set(e,t,n),s.position.set(i,a,o),s}function il(e,t,n,r,i=0,a=0,o=0){let s=new W(el,r);return s.scale.set(e||t,n,e||t),e!==t&&(s.geometry=new _i(e,t,1,8),s.scale.set(1,n,1)),s.position.set(i,a,o),s}function al(e,t=!0,n=!1){return e.traverse(e=>{e.isMesh&&(e.castShadow=t,e.receiveShadow=n)}),e}var ol=[J.awningRed,J.awningGreen,J.awningBlue,J.awningBurg],sl=[J.brickRedA,J.brickRedB,J.brickTan,J.cream,J.stoneGray];function cl(e,t){let n=new U,r=new W($c,t);r.scale.set(e,.08,1.3),r.rotation.x=.42,r.position.set(0,0,.55),n.add(r);let i=Y(e,.28,.06,t,0,-.32,1.12);return n.add(i),n}function ll(e=Math.random,t=10){let n=new U,r=2+Math.floor(e()*2),i=3.1,a=r*i+.6,o=sl[Math.floor(e()*sl.length)],s=Y(7,a,t-.15,o,0,a/2,0);n.add(s),n.add(Y(7.4,.5,t-.25,J.trimWhite,0,a+.25,0));let c=-7/2,l=t*.8,u=e()<.75;n.add(Y(.1,2.3,l,u?J.interiorGlow:J.interiorDark,-2.6,1.3,0)),n.add(Y(1,.1,l,J.interiorDark,-3.05,2.42,0));let d=Math.floor(e()*3);for(let e=0;e<3;e++){let t=-l/2+(e+.5)*(l/3);d===0?n.add(Y(.5,1.15,1,J.interiorProp,-2.95,.6,t)):d===1?(n.add(Y(.06,1.25,.9,J.interiorProp,-3,.65,t)),n.add(Y(.4,.08,.9,J.interiorProp,-3,1.28,t))):e===1&&n.add(Y(.55,.95,l*.55,J.interiorProp,-2.9,.5,0))}n.add(Y(.06,2.3,l,J.glassClear,c-.02,1.3,0));for(let e of[-l/2,0,l/2])n.add(Y(.1,2.3,.1,J.trimDark,c-.03,1.3,e));let f=t*.5-(t-l)/4-.6,p=[J.doorGreen,J.doorRed,J.doorBlue,J.trimDark],m=p[Math.floor(e()*p.length)];if(n.add(Y(.3,2.5,1.3,o,-3.4,1.25,f)),n.add(Y(.1,2.45,1.1,J.trimWhite,c-.06,1.22,f)),n.add(Y(.08,2.25,.85,m,c-.1,1.12,f)),n.add(Y(.06,.8,.6,J.glass,c-.14,1.55,f)),n.add(Y(.05,.16,.06,J.trimWhite,c-.15,1.05,f-.3)),n.add(Y(.12,.06,1.2,J.stoneGray,c-.15,.03,f)),n.add(Y(.2,.45,t*.9,J.trimDark,c-.05,2.72,0)),e()<.8){let r=cl(l*(.55+e()*.3),ol[Math.floor(e()*ol.length)]);r.rotation.y=-Math.PI/2,r.position.set(c-.2,2.55,(e()-.5)*t*.15),n.add(r)}for(let a=1;a<r;a++){let r=a*i+1.5,o=Math.max(2,Math.floor(t/2.4));for(let i=0;i<o;i++){let a=-t/2+(i+.5)*(t/o);n.add(Y(.3,1.5,1,e()<.2?J.glassWarm:J.glass,-3.48,r,a)),n.add(Y(.34,.14,1.2,J.trimWhite,c,r+.85,a)),n.add(Y(.34,.12,1.2,J.trimWhite,c,r-.85,a))}}if(e()<.4){let r=Y(.25,2.2,.5,ol[Math.floor(e()*ol.length)],c-.5,4.7,t*.3);n.add(r)}return al(n)}function ul(){let e=new U;e.add(il(.07,.1,4.4,J.ironBlack,0,2.2,0)),e.add(il(.16,.16,.3,J.ironBlack,0,.15,0));let t=il(.05,.05,1,J.ironBlack,.32,4.55,0);t.rotation.z=1.25,e.add(t);let n=il(.05,.05,.5,J.ironBlack,.78,4.42,0);n.rotation.z=2.1,e.add(n);let r=new W(tl,J.lampGlow);r.scale.set(.22,.28,.22),r.position.set(.95,4.2,0),e.add(r);let i=il(.3,.16,.14,J.ironBlack,.95,4.42,0);return e.add(i),al(e)}function dl(e=!0){let t=new U,n=e?J.woodBrown:J.ironBlack;for(let e=0;e<4;e++)t.add(Y(.13,.035,1.7,n,-.24+e*.16,.46,0)),t.add(Y(.035,.13,1.7,n,-.33+e*.02,.62+e*.15,0));for(let e of[-.78,.78]){t.add(Y(.5,.06,.06,J.ironBlack,0,.44,e));let n=Y(.06,.7,.06,J.ironBlack,-.32,.75,e);n.rotation.z=-.12,t.add(n),t.add(Y(.06,.44,.06,J.ironBlack,.22,.22,e)),t.add(Y(.06,.44,.06,J.ironBlack,-.24,.22,e)),t.add(Y(.42,.05,.05,J.ironBlack,.02,.66,e)),t.add(Y(.3,.05,.06,J.ironBlack,0,.02,e))}return al(t)}function fl(e=!1){let t=new U,n=2.4+Math.random()*.8;t.add(il(.13,.18,n,J.trunk,0,n/2,0));let r=e?[J.leafFall,J.leafGreenB]:[J.leafGreen,J.leafGreenB],i=3+Math.floor(Math.random()*2);for(let e=0;e<i;e++){let i=new W(nl,r[e%r.length]),a=1+Math.random()*.7;i.scale.set(a,a*.85,a),i.position.set((Math.random()-.5)*1.2,n+.6+Math.random()*1,(Math.random()-.5)*1.2),t.add(i)}return t.add(il(.55,.55,.06,J.ironBlack,0,.03,0)),al(t)}function pl(e=!1){let t=new U,n=e?.55:.38,r=e?.45:.38;t.add(il(n*.92,n*.7,r,J.planterClay,0,r/2,0)),t.add(il(n,n,.09,J.planterClay,0,r,0));let i=[J.awningRed,J.flag[1],J.umbCream,J.flag[4]];for(let a=0;a<(e?5:3);a++){let e=new W(nl,i[a%i.length]);e.scale.setScalar(.09+Math.random()*.05),e.position.set((Math.random()-.5)*n*1.1,r+.16+Math.random()*.08,(Math.random()-.5)*n*1.1),t.add(e);let o=new W(nl,J.leafGreenB);o.scale.set(.12,.07,.12),o.position.set(e.position.x,r+.08,e.position.z),t.add(o)}return al(t)}function ml(){let e=new U,t=Y(.05,.92,.62,J.woodBrown,-.15,.44,0);t.rotation.z=-.3;let n=Y(.05,.92,.62,J.woodBrown,.15,.44,0);n.rotation.z=.3,e.add(t,n);let r=Y(.02,.6,.48,J.chalkWhite,-.19,.44,0);r.rotation.z=-.3,e.add(r);let i=Y(.015,.08,.34,J.trimDark,-.225,.58,0);return i.rotation.z=-.3,e.add(i),e.scale.setScalar(1.35),al(e)}function hl(){let e=new U;e.add(Y(.45,.05,.45,J.ironBlack,0,.45,0)),e.add(Y(.45,.5,.05,J.ironBlack,0,.72,-.2));for(let[t,n]of[[-.18,-.18],[.18,-.18],[-.18,.18],[.18,.18]])e.add(Y(.04,.45,.04,J.ironBlack,t,.22,n));return e.scale.setScalar(1.25),al(e)}function gl(e){let t=new U;t.add(il(.5,.5,.05,J.woodLight,0,.72,0)),t.add(il(.04,.04,.72,J.ironBlack,0,.36,0)),t.add(il(.03,.03,1.5,J.ironBlack,0,1.5,0));let n=new W(rl,e||J.umbRed);return n.scale.set(1.15,.45,1.15),n.position.y=2.25,t.add(n),al(t)}function _l(){let e=new U;for(let t of[-.7,.7]){let n=Y(.07,1,.07,J.orange,.2,.5,t);n.rotation.z=-.35;let r=Y(.07,1,.07,J.orange,-.2,.5,t);r.rotation.z=.35,e.add(n,r)}return e.add(Y(.1,.28,1.7,J.orange,0,.82,0)),e.add(Y(.11,.09,1.7,J.safetyStripe,0,.82,0)),e.add(Y(.1,.2,1.7,J.orange,0,.35,0)),al(e)}function vl(){let e=new U;e.add(Y(.5,.06,.5,J.orange,0,.03,0));let t=new W(rl,J.orange);t.scale.set(.22,.62,.22),t.position.y=.34,e.add(t);let n=il(.15,.18,.12,J.safetyStripe,0,.35,0);return e.add(n),al(e)}function yl(){let e=new U;e.add(Y(.7,.5,.7,J.cardboard,0,.25,0)),e.add(Y(.55,.4,.55,J.cardboard,.1,.7,.05));let t=Y(.4,.35,.4,J.cardboard,-.15,.42,-.35);return t.rotation.y=.4,e.add(t),al(e)}function bl(){let e=new U,t=new Ci(.3,.035,6,14);for(let n of[-.45,.45]){let r=new W(t,J.ironBlack);r.position.set(n,.3,0),e.add(r)}let n=Y(.55,.05,.05,J.bikeBlue,0,.62,0);n.rotation.z=.25;let r=Y(.5,.05,.05,J.bikeBlue,-.2,.45,0);r.rotation.z=-.9;let i=Y(.5,.05,.05,J.bikeBlue,.25,.45,0);return i.rotation.z=1.1,e.add(n,r,i),e.add(Y(.05,.3,.05,J.ironBlack,-.42,.75,0)),e.add(Y(.05,.04,.4,J.ironBlack,-.42,.92,0)),e.add(Y(.25,.05,.12,J.trimDark,.42,.85,0)),al(e)}function xl(e=1){let t=new U,n=new W(nl,J.boulder);n.scale.set(e*(.8+Math.random()*.3),e*.62,e*(.65+Math.random()*.25)),n.rotation.set(Math.random()*.4,Math.random()*Math.PI,Math.random()*.3),n.position.y=e*.5,t.add(n);let r=new W(nl,J.boulderB);return r.scale.set(e*.5,e*.35,e*.45),r.rotation.y=Math.random()*Math.PI,r.position.set(e*.5,e*.22,e*.2),t.add(r),al(t)}function Sl(){let e=new U;e.add(xl(1.3));let t=xl(.8);return t.position.set(1.4,0,.8),e.add(t),e}function Cl(){let e=new U;e.add(il(.34,.3,.85,J.awningGreen,0,.43,0)),e.add(il(.37,.37,.07,J.ironBlack,0,.88,0)),e.add(il(.12,.3,.1,J.ironBlack,0,.97,0));for(let t=0;t<5;t++){let n=Y(.03,.75,.03,J.ironBlack,Math.cos(t*1.256)*.33,.43,Math.sin(t*1.256)*.33);e.add(n)}return al(e)}function wl(){let e=new U;e.add(Y(.5,.75,.45,J.ironBlack,0,.62,0)),e.add(Y(.36,.4,.03,J.chalkWhite,0,.72,-.225)),e.add(Y(.3,.06,.02,J.trimDark,0,.82,-.24)),e.add(Y(.44,.06,.4,J.ironBlack,0,1.02,0));for(let[t,n]of[[-.18,-.15],[.18,-.15],[-.18,.15],[.18,.15]])e.add(Y(.05,.26,.05,J.ironBlack,t,.13,n));return e.scale.setScalar(1.15),al(e)}function Tl(){let e=new U;for(let t of[-1,1])e.add(il(.05,.07,2.5,J.ironBlack,0,1.25,t)),e.add(il(.18,.2,.08,J.ironBlack,0,.04,t));let t=Y(.06,.75,2.2,J.flag[3],0,1.85,0);return e.add(t),e.add(Y(.07,.1,2.2,J.safetyStripe,0,2.26,0)),e.add(Y(.07,.1,2.2,J.safetyStripe,0,1.46,0)),al(e)}function El(){let e=new U;e.add(Y(.08,1.7,.08,J.ironBlack,-.3,.85,-.28)),e.add(Y(.08,1.7,.08,J.ironBlack,.3,.85,-.28)),e.add(Y(.7,.06,.5,J.ironBlack,0,.08,0));let t=new W(new Ci(.14,.05,6,10),J.trimDark);t.position.set(-.3,.14,-.3),e.add(t);let n=t.clone();return n.position.x=.3,e.add(n),e.add(Y(.62,.5,.5,J.cardboard,0,.4,0)),e.add(Y(.58,.45,.46,J.cardboard,.02,.88,-.02)),e.add(Y(.5,.42,.42,J.cardboard,-.03,1.3,.02)),e.add(Y(.44,.38,.38,J.cardboard,.02,1.7,0)),al(e)}function Dl(){let e=new U;e.add(Y(1.9,1,1,J.awningBlue,0,.85,0)),e.add(Y(1.95,.08,1.05,J.trimWhite,0,1.4,0)),e.add(Y(.5,.28,.02,J.trimWhite,-.4,.85,-.52)),e.add(Y(.5,.28,.02,J.awningRed,.45,.85,-.52));for(let[t,n]of[[-.9,-.45],[.9,-.45],[-.9,.45],[.9,.45]])e.add(il(.03,.03,1.1,J.ironBlack,t,1.95,n));e.add(Y(2.1,.09,1.2,J.awningRed,0,2.5,0));for(let t=0;t<7;t++){let n=new W(tl,J.lampGlow);n.scale.setScalar(.045),n.position.set(-.9+t*.3,2.32-Math.sin(t/6*Math.PI)*.12,-.55),e.add(n)}let t=new Ci(.22,.06,6,12);for(let n of[-.7,.7]){let r=new W(t,J.ironBlack);r.position.set(n,.24,.4),e.add(r)}let n=ml();return n.position.set(1.5,0,-.4),n.rotation.y=.6,e.add(n),al(e)}var Ol=[9321266,3495534,7436907,2894896,13617336];function kl(e=Math.floor(Math.random()*Ol.length)){let t=new U,n=new G({color:Ol[e%Ol.length]});t.add(Y(3.6,.55,1.6,n,0,.55,0)),t.add(Y(1.9,.5,1.45,n,-.1,1.05,0)),t.add(Y(1.7,.4,1.3,J.glass,-.1,1.1,0));let r=new _i(.32,.32,.22,10);for(let[e,n]of[[-1.15,-.8],[1.15,-.8],[-1.15,.8],[1.15,.8]]){let i=new W(r,J.trimDark);i.rotation.x=Math.PI/2,i.position.set(e,.32,n),t.add(i)}return t.add(Y(.12,.14,1.3,J.lampGlow,1.82,.6,0)),al(t)}function Al(){let e=new U,t=new G({color:15263455});e.add(Y(1.7,.7,1.1,t,0,.6,0)),e.add(Y(1.1,.85,1,t,-.15,1.35,0)),e.add(Y(.95,.6,.9,J.glass,-.15,1.4,0)),e.add(Y(.5,.06,.5,J.orange,-.15,1.82,0));let n=il(.09,.11,.14,J.orange,-.15,1.92,0);e.add(n);let r=new _i(.24,.24,.18,10);for(let[t,n]of[[.6,-.55],[.6,.55],[-.65,0]]){let i=new W(r,J.trimDark);i.rotation.x=Math.PI/2,i.position.set(t,.24,n),e.add(i)}return e.add(Y(.35,.18,.9,J.awningBlue,.4,.85,0)),al(e)}function jl(e,t=5.6){let n=new U,r=new Ar;r.setAttribute(`position`,new vr([-.14,0,0,.14,0,0,0,-.34,0],3)),r.computeVertexNormals();let i=Math.floor(e/.55);for(let a=0;a<=i;a++){let o=a/i,s=-e/2+o*e,c=Math.sin(o*Math.PI)*-.9,l=new W(r,J.flag[a%J.flag.length]);l.position.set(s,t+c,0),n.add(l)}return n}var Ml=new hi(1,1,1),Nl=new Si(1,8,6),Pl=new _i(1,1,1,8),Fl=[15250570,13209186,10251077,7293488,15780260],Il=[3107663,9321266,3495534,13071404,7101327,4013373,14208952,6000552],Ll=[3882826,6047282,2894896,7432026,4610154];function Rl(e){return new G({color:e})}function X(e,t,n,r,i,a,o,s){let c=new W(e,t);return c.scale.set(n,r,i),c.position.set(a,o,s),c.castShadow=!0,c}function zl(e,t,n,r,i,a,o){let s=new U;s.position.set(i,a,o);let c=new W(Ml,r);return c.scale.set(e,t,n),c.position.y=-t/2,c.castShadow=!0,s.add(c),s}function Bl(e,t=Math.random){return e[Math.floor(t()*e.length)]}function Vl(e={}){let t=new U,n=Rl(e.skin??Bl(Fl)),r=Rl(e.shirt??Bl(Il)),i=Rl(e.pants??Bl(Ll)),a=e.scale??.85+Math.random()*.2;if(e.dress){let e=new W(new _i(.2,.42,.85,8),r);e.position.y=.85,e.castShadow=!0,t.add(e),t.add(X(Ml,r,.42,.35,.26,0,1.35,0))}else t.add(X(Ml,r,.48,.6,.28,0,1.05,0));let o=X(Nl,n,.2,.22,.2,0,1.6,0);if(t.add(o),e.hat===`cap`)t.add(X(Ml,Rl(e.hatColor??11549232),.32,.14,.32,0,1.75,.02)),t.add(X(Ml,Rl(e.hatColor??11549232),.3,.05,.4,0,1.68,-.08));else if(e.hat===`brim`){let n=X(Pl,Rl(e.hatColor??14997168),.42,.05,.42,0,1.72,0);t.add(n),t.add(X(Pl,Rl(e.hatColor??14997168),.2,.15,.2,0,1.8,0))}else e.hat===`beanie`?t.add(X(Nl,Rl(e.hatColor??9321266),.21,.16,.21,0,1.72,0)):t.add(X(Nl,Rl(e.hair??Bl([2892056,4864035,9071162,5592405])),.21,.14,.21,0,1.72,0));let s=e.dress?n:i,c=zl(.15,e.dress?.42:.55,.16,s,-.13,e.dress?.46:.72,0),l=zl(.15,e.dress?.42:.55,.16,s,.13,e.dress?.46:.72,0),u=zl(.11,.48,.13,e.dress?n:r,-.32,1.32,0),d=zl(.11,.48,.13,e.dress?n:r,.32,1.32,0);if(t.add(c,l,u,d),e.bags){let n=X(Ml,Rl(13082972),.24,.3,.18,-.42,.62,0);u.rotation.x=.1,t.add(n),e.bags>1&&t.add(X(Ml,Rl(14209732),.22,.28,.16,.44,.6,0))}if(e.coffee&&(d.rotation.x=-1.1,t.add(X(Pl,Rl(15789024),.05,.14,.05,.34,1.12,-.32))),e.backpack&&t.add(X(Ml,Rl(e.backpackColor??13071404),.36,.45,.18,0,1.15,.24)),e.mailbag&&(t.add(X(Ml,Rl(3100019),.2,.34,.3,-.4,.95,0)),t.add(X(Ml,Rl(3100019),.04,.5,.04,-.28,1.45,0))),e.phone&&(d.rotation.x=-1.35,t.add(X(Ml,Rl(2236966),.06,.14,.03,.33,1.28,-.4))),e.afro){let e=X(Nl,Rl(1840914),.32,.3,.32,0,1.78,0);t.add(e)}if(e.basketball){d.rotation.x=-.2,d.rotation.z=.35;let e=X(Nl,Rl(13789470),.17,.17,.17,.48,.95,0);t.add(e),t.userData.ball=e,t.userData.ballArm=d}return t.scale.setScalar(a),t.userData.limbs={legL:c,legR:l,armL:u,armR:d},t.userData.phase=Math.random()*Math.PI*2,t}function Hl(e,t,n=7){let r=e.userData.limbs;if(!r)return;let i=Math.sin(t*n+e.userData.phase)*.55;r.legL.rotation.x=i,r.legR.rotation.x=-i,r.armL.rotation.x>-.9&&(r.armL.rotation.x=-i*.7),r.armR.rotation.x>-.9&&(r.armR.rotation.x=i*.7);let a=e.userData.ball;if(a){let r=Math.abs(Math.sin(n*1.6*t+e.userData.phase));a.position.y=.17+r*.72,e.userData.ballArm.rotation.x=-.05-(1-r)*.4,e.userData.ballArm.rotation.z=.35}}function Ul(e={}){let t=Vl({...e,scale:e.scale??.9}),n=t.userData.limbs;return n.legL.rotation.x=-1.45,n.legR.rotation.x=-1.45,n.armL.rotation.x=-.9,n.armR.rotation.x=-.9,t.position.y=-.32,t.userData.seated=!0,t}var Wl={black:{body:1907738,ear:1118480,s:1.35},golden:{body:13212242,ear:11567679,s:1.35},small:{body:14998731,ear:12892318,s:.95},shaggy:{body:9073752,ear:7232066,s:1.3,shag:!0},brown:{body:7031343,ear:5585444,s:1.25}};function Gl(e=`golden`){let t=Wl[e]||Wl.golden,n=new U,r=Rl(t.body),i=X(Ml,r,.7,.34,.3,0,.42,0);n.add(i),t.shag&&n.add(X(Ml,Rl(t.ear),.72,.12,.32,0,.28,0)),n.add(X(Ml,r,.26,.24,.24,.42,.62,0)),n.add(X(Ml,r,.14,.1,.14,.56,.55,0)),n.add(X(Ml,Rl(t.ear),.08,.14,.06,.36,.76,-.1)),n.add(X(Ml,Rl(t.ear),.08,.14,.06,.36,.76,.1));let a=X(Ml,r,.26,.06,.06,-.42,.56,0);a.rotation.z=.6,n.add(a);let o=[];for(let[e,t]of[[-.24,-.1],[-.24,.1],[.24,-.1],[.24,.1]]){let i=zl(.09,.28,.09,r,e,.3,t);o.push(i),n.add(i)}return n.scale.setScalar(t.s),n.userData.legs=o,n.userData.tail=a,n.userData.phase=Math.random()*6,n}var Kl=Object.keys(Wl);function ql(e,t,n=10){let{legs:r,tail:i,phase:a}=e.userData;if(!r)return;let o=Math.sin(t*n+a)*.7;r[0].rotation.z=o,r[1].rotation.z=o,r[2].rotation.z=-o,r[3].rotation.z=-o,i&&(i.rotation.z=.6+Math.sin(t*n*1.3+a)*.25)}function Jl(e=`guitar`){let t=new U,n=Vl({scale:.95});t.add(n);let r=n.userData.limbs;if(e===`guitar`){r.armL.rotation.x=-1,r.armR.rotation.x=-.7;let e=X(Ml,Rl(10251056),.14,.5,.34,0,1,-.3);e.rotation.z=.5,t.add(e),t.add(X(Ml,Rl(6045728),.05,.5,.06,.2,1.4,-.3));let n=X(Ml,Rl(3354668),.5,.08,.9,.9,.04,0);t.add(n)}else if(e===`sax`){r.armL.rotation.x=-1.1,r.armR.rotation.x=-1.1;let e=X(Pl,Rl(13213742),.07,.5,.07,0,1.05,-.28);e.rotation.x=.5,t.add(e),t.add(X(Nl,Rl(13213742),.12,.12,.12,0,.78,-.42))}else if(e===`violin`){r.armL.rotation.x=-1.3,r.armR.rotation.x=-1.2;let e=X(Ml,Rl(9062944),.1,.32,.16,-.15,1.5,-.25);e.rotation.z=1.1,t.add(e)}return t}function Yl(){let e=new U,t=Rl(13851425);for(let[t,n]of[[-1.6,-1.4],[1.6,-1.4],[-1.6,1.4],[1.6,1.4]])e.add(X(Pl,J.ironBlack,.05,2.3,.05,t,1.15,n));let n=new W(new vi(2.6,.9,4),t);n.rotation.y=Math.PI/4,n.position.y=2.75,n.castShadow=!0,e.add(n),e.add(X(Ml,t,3.6,.35,3.2,0,2.25,0));let r=Jl(`guitar`);r.position.set(-.9,0,.3),r.rotation.y=Math.PI,e.add(r);let i=Jl(`guitar`);i.position.set(.9,0,.3),i.rotation.y=Math.PI,e.add(i);let a=Ul({});return a.position.set(0,0,1),a.rotation.y=Math.PI,e.add(a),e.add(X(Pl,Rl(11549232),.32,.4,.32,0,.35,.5)),e.add(X(Pl,Rl(14209732),.2,.12,.2,-.4,.62,.6)),e.add(X(Pl,Rl(13213742),.26,.02,.26,.45,1,.6)),e.add(X(Pl,J.ironBlack,.02,.9,.02,.45,.55,.6)),e.add(X(Ml,Rl(2236966),.5,1,.5,-1.9,.5,.4)),e.add(X(Ml,Rl(2236966),.5,1,.5,1.9,.5,.4)),e}var Xl=[()=>Vl({coffee:!0}),()=>Vl({bags:2}),()=>Vl({phone:!0}),()=>Vl({dress:!0,hat:`brim`}),()=>Vl({backpack:!0,hat:`beanie`}),()=>Vl({hat:`cap`}),()=>Vl({})],Zl=class{constructor(e,t=10){this.scene=e,this.walkers=[];for(let e=0;e<t;e++){let t=Xl[e%Xl.length](),n=new U;n.add(t);let r=null;if(e%3==0){r=Gl(Kl[e%Kl.length]),r.position.set(.3,0,-.9),r.rotation.y=Math.PI/2,n.add(r);let t=new W(Ml,J.ironBlack);t.scale.set(.015,.015,1),t.position.set(.2,.85,-.45),t.rotation.x=.5,n.add(t)}let i=e%2==0?-1:1,a=Math.random()<.6?1:-1;n.position.set(i*(5+Math.random()*1),0,-20-Math.random()*120),n.rotation.y=a===1?Math.PI:0,this.scene.add(n),this.walkers.push({grp:n,person:t,dog:r,dir:a,side:i,speed:.8+Math.random()*.9})}}update(e,t,n){for(let r of this.walkers)r.grp.position.z+=e+r.dir*r.speed*t,Hl(r.person,n,6),r.dog&&ql(r.dog,n,7),r.grp.position.z>12?(r.grp.position.z=-140-Math.random()*30,r.side*=Math.random()<.4?-1:1,r.grp.position.x=r.side*(5+Math.random()*1)):r.grp.position.z<-155&&(r.grp.position.z=-20)}reset(){for(let e of this.walkers)e.grp.position.z=-20-Math.random()*120}},Ql=new hi(1,1,1),$l=new Si(1,8,6),eu=new _i(1,1,1,8);function Z(e,t,n,r,i,a,o=J.bronze,s=Ql){let c=new W(s,o);return c.scale.set(e,t,n),c.position.set(r,i,a),c.castShadow=!0,c}function tu(e=1.6,t=.35,n=1.6){return Z(e,t,n,0,t/2,0,J.granite)}function nu(){let e=new U;e.add(tu(1.7,.4,1.7)),e.add(Z(.56,.7,.34,0,1.4500000000000002,0)),e.add(Z(.6,.12,.38,0,1.8199999999999998,0));let t=Z(.22,.24,.22,0,2.02,-.06,J.bronze,$l);t.rotation.x=.25,e.add(t),e.add(Z(.3,.06,.3,0,2.14,-.04,J.bronzeDark,eu));for(let t of[-1,1]){e.add(Z(.16,.75,.18,t*.16,.78,0));let n=Z(.13,.5,.14,t*.36,1.5499999999999998,-.15);n.rotation.x=-.9,e.add(n)}let n=Z(.08,.6,.08,0,1.4,-.3,J.bronzeDark,eu);n.rotation.x=.35,e.add(n),e.add(Z(.16,.14,.16,.02,1.06,-.42,J.bronzeDark,$l));let r=Z(.1,.34,.1,-.42,1.7999999999999998,-.28);return r.rotation.x=-1.4,e.add(r),e}function ru(){let e=new U;e.add(tu(1.5,.22,1.5));let t=.22,n=new U;n.add(Z(.4,.3,.6,0,.75,0)),n.add(Z(.18,.2,.18,0,.72,-.38,J.bronze,$l)),n.add(Z(.14,.72,.16,-.12,.36,.2)),n.add(Z(.14,.72,.16,.12,.36,.2));for(let e of[-1,1]){let t=Z(.1,.5,.1,e*.2,.5,-.25);t.rotation.x=.35,n.add(t)}n.position.y=t,e.add(n);let r=new U;r.add(Z(.4,.55,.3,0,1.45,.1)),r.add(Z(.19,.21,.19,0,1.85,.05,J.bronze,$l)),r.add(Z(.34,.1,.2,0,1.98,.02,J.bronzeDark));for(let e of[-1,1]){let t=Z(.1,.5,.1,e*.26,1.3,-.05);t.rotation.x=.9,r.add(t);let n=Z(.13,.6,.14,e*.3,1.05,.25);n.rotation.z=e*.8,r.add(n)}return r.position.y=t,e.add(r),e}function iu(){let e=new U;e.add(Z(2.4,.3,1.6,0,.15,0,J.granite)),e.add(Z(1.6,.3,1.2,-.3,.45,0,J.granite));let t=new U;t.add(Z(.9,.42,.34,0,1,0));let n=Z(.18,.5,.2,.42,1.3,0);n.rotation.z=-.5,t.add(n),t.add(Z(.3,.18,.16,.62,1.52,0));for(let e of[-1,1]){let n=Z(.04,.34,.04,.58,1.75,e*.08);n.rotation.z=.3,t.add(n),t.add(Z(.03,.18,.03,.64,1.85,e*.12))}t.add(Z(.1,.65,.12,.32,.5,-.1));let r=Z(.1,.72,.12,.38,.42,.1);return r.rotation.x=.25,t.add(r),t.add(Z(.1,.6,.12,-.34,.52,-.1)),t.add(Z(.1,.6,.12,-.34,.52,.1)),t.position.y=.42,e.add(t),e}function au(){let e=new U;e.add(Z(1.7,.35,1.3,0,.17,0,J.granite)),e.add(Z(.95,.6,.6,0,.77,0,J.bronzeDark,$l)),e.add(Z(.34,.3,.32,.5,.95,0,J.bronzeDark,$l)),e.add(Z(.1,.1,.08,.68,.91,0,J.bronzeDark,$l));for(let t of[-1,1])e.add(Z(.09,.09,.05,.48,1.13,t*.12,J.bronzeDark,$l));return e.add(Z(.2,.4,.2,.35,.5,.2,J.bronzeDark)),e.add(Z(.4,.28,.3,-.25,1.2,0,J.bronzeDark,$l)),e.add(Z(.16,.15,.15,-.05,1.2999999999999998,0,J.bronzeDark,$l)),e}function ou(){let e=new U,t=12.5,n=new G({color:3955282});e.add(Y(7,t,12,J.brickRedB,0,t/2,0)),e.add(Y(7.3,.7,12.2,J.trimWhite,0,12.85,0)),e.add(Y(7.1,.35,12.1,J.stoneGray,0,3.1,0));let r=-7/2;e.add(Y(.2,.8,12*.9,J.stoneGray,r-.05,.4,0)),e.add(Y(.15,2,12*.82,J.glassWarm,r-.08,1.8,0));for(let t of[-12*.28,0,12*.28])e.add(Y(.2,2,.25,J.stoneGray,r-.06,1.8,t));for(let[t,i]of[[-12*.3,5.2],[0,6.4],[12*.3,5.2]]){e.add(Y(.14,i,2.1,n,r-.05,3.6+i/2,t)),e.add(Y(.16,i-.35,1.75,J.glass,r-.08,3.6+i/2,t));let a=new W(new _i(1.05,1.05,.15,12,1,!1,0,Math.PI),n);a.rotation.z=Math.PI/2,a.rotation.y=Math.PI/2,a.position.set(r-.05,3.6+i,t),a.castShadow=!0,e.add(a),t!==0&&e.add(Y(.1,i*.8,.35,new G({color:14726446}),r-.25,3.6+i/2,t+1.2))}e.add(Y(.18,.6,12*.85,J.stoneGray,r-.07,3.45,0)),e.add(Y(2.4,1.8,2.4,J.brickRedB,0,13.4,-12*.18)),e.add(Y(2.2,1.6,2.2,new G({color:5924464}),0,14.9,-12*.18));let i=new W(new vi(1.9,1.3,4),new G({color:4674140}));return i.rotation.y=Math.PI/4,i.position.set(0,16.3,-12*.18),i.castShadow=!0,e.add(i),e.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),e}function su(){let e=new U;e.add(Y(8,10,22,J.brickRedA,0,10/2,0)),e.add(Y(8.4,.8,22.4,J.trimWhite,0,10.4,0));for(let t=0;t<7;t++){let n=-9.5+t*19/6;e.add(Y(.25,8.5,.9,J.cream,-4.08,5.4,n))}for(let t=0;t<6;t++){let n=-9.5+(t+.5)*19/6;e.add(Y(.14,1.8,1.1,J.glass,-4.12,6.6,n)),e.add(Y(.14,1.8,1.1,J.glass,-4.12,3.6,n))}e.add(Y(2.2,1.1,5,J.granite,-5,.55,0)),e.add(Y(1.2,.55,6.4,J.granite,-5.9,.27,0)),e.add(Y(.3,2.6,2.2,J.trimWhite,-4.1,2.5,0)),e.add(Y(.2,2.1,1.3,J.trimWhite,-4.25,2.2,0)),e.add(Y(.15,1.9,1,J.doorGreen,-4.3,2.05,0));for(let t of[-1,1])e.add(Y(1.6,.5,.08,J.ironBlack,-5.4,1.45,t*2.4));e.add(Y(2.6,2.2,2.6,J.trimWhite,0,11.8,0));let t=new W(new _i(.55,.55,.1,16),J.chalkWhite);t.rotation.z=Math.PI/2,t.position.set(-1.35,12.1,0),e.add(t);let n=new W(new Si(.9,10,8),new G({color:14266940}));return n.scale.y=.7,n.position.set(0,13.3,0),e.add(n),e.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),e}function cu(){let e=new U,t=6.8,n=new G({color:2792880}),r=new G({color:15305400});e.add(Y(7,t,11,J.brickTan,0,t/2,0)),e.add(Y(7.3,.4,11.2,J.trimDark,0,7,0));let i=-7/2;e.add(Y(.25,1.1,11*.9,n,i-.1,3.3,0)),e.add(Y(.28,.25,11*.6,J.chalkWhite,i-.12,3.3,0)),e.add(Y(.1,2.2,11*.8,J.interiorGlow,-2.7,1.25,0)),e.add(Y(.5,.9,11*.5,J.interiorProp,-3,.45,.6)),e.add(Y(.06,2.2,11*.8,J.glassClear,i-.02,1.25,0));let a=new W(new vi(.4,1,8),J.cardboard);a.rotation.x=Math.PI,a.position.set(i-.55,4.7,11*.32),e.add(a);let o=new W($l,r);o.scale.set(.45,.5,.45),o.position.set(i-.55,5.5,11*.32),e.add(o);let s=new W(new vi(.28,.55,8),J.chalkWhite);s.position.set(i-.55,5.95,11*.32),e.add(s);let c=[n,J.chalkWhite,J.woodLight,r];for(let t=0;t<6;t++)e.add(Y(.35,.16,1.5,c[t%4],i-.9,.15+t%3*.18,-11*.25+Math.floor(t/3)*1.6));for(let t=0;t<3;t++){let n=new W(new bi(1,1),J.leafGreenB);n.scale.set(.3,.22,.3),n.position.set(i-.9,.65,-11*.25+t*.8),e.add(n)}for(let t=0;t<3;t++)e.add(Y(.12,1.3,1,J.glass,i-.04,5.2,-11/2+(t+.5)*(11/3)));for(let t=0;t<2;t++){let n=Vl({coffee:!1});n.position.set(i-1.6,0,1.2-t*2.2),n.rotation.y=Math.PI/2;let a=new W(new vi(.07,.2,6),J.cardboard);a.rotation.x=Math.PI,a.position.set(.35,1.2,-.3),n.add(a);let o=new W($l,t?r:J.chalkWhite);o.scale.setScalar(.09),o.position.set(.35,1.33,-.3),n.add(o),e.add(n)}return e.traverse(e=>{e.isMesh&&e.castShadow===void 0&&(e.castShadow=!0)}),e}var lu=`https://guide.btownbrief.com/data/ticker.json`,uu=[`BTV: Farmers Market returns to City Hall Park Saturday`,`Church St buskers festival draws record crowds`,`Lake Champlain water temps hit summer highs`,`New creemee stand opens on the waterfront`,`Bike path repaving finishes ahead of schedule`,`Leaf peepers arrive early this fall, says UVM`,`City council debates more benches for Church St`,`Local dog wins Vermont's goodest boy award`],du=e=>({chip:`BTV`,text:String(e)}),fu=(e,t=110)=>e.length<=t?e:e.slice(0,t-1).trimEnd()+`…`,pu=uu.map(du),mu={title:`the latest Btown Brief`,url:`https://www.btownbrief.com/`},hu=0,gu=[];function _u(e){let t=(e.headlines||[]).map(String),n=(e.week||[]).map(e=>({chip:`EVENT`,text:fu(`${e.label}: ${e.text}`)})).concat((e.upcoming||[]).map(e=>({chip:`EVENT`,text:fu(`${e.label}: ${e.text}${e.note?` — `+e.note:``}`)})));if(!t.length)return null;let r=[],i=Math.floor(Math.random()*t.length),a=0,o=Math.min(t.length+n.length,60);for(let e=0;e<o;e++)n.length&&e%3==2?r.push(n[a++%n.length]):r.push(du(t[i++%t.length]));return r}async function vu(){let e=null;try{let t=await fetch(lu,{cache:`no-store`});if(t.ok){let n=await t.json();e=_u(n),e&&n.latest?.url&&(mu=n.latest)}}catch{}if(!e)try{let t=await fetch(`./news.json`,{cache:`no-store`});if(t.ok){let n=await t.json();Array.isArray(n)&&n.length?e=n.map(du):n&&Array.isArray(n.headlines)&&n.headlines.length&&(e=n.headlines.map(du),n.latest?.url&&(mu=n.latest))}}catch{}if(e){pu=e;let t=0;for(let e of gu)e.userData.setHeadline(pu[t++%pu.length]);hu=t%pu.length}}function yu(){return mu}function bu(){return localStorage.getItem(`csr-news`)!==`off`}function xu(e){localStorage.setItem(`csr-news`,e?`on`:`off`)}function Su(e){let{chip:t,text:n}=typeof e==`string`?{chip:`BTV`,text:e}:e,r=document.createElement(`canvas`);r.width=1024,r.height=96;let i=r.getContext(`2d`);i.fillStyle=`#1e2b38`,i.fillRect(0,0,1024,96),i.fillStyle=`#e8b23a`,i.font=`bold 34px system-ui, sans-serif`;let a=Math.max(148,i.measureText(t).width+76);i.fillRect(0,0,a,96),i.fillStyle=`#1e2b38`,i.fillText(t,38,60),i.fillStyle=`#f3ede0`;let o=1024-a-56,s=40;for(i.font=`600 ${s}px system-ui, sans-serif`;s>22&&i.measureText(n).width>o-10;)s-=2,i.font=`600 ${s}px system-ui, sans-serif`;i.fillText(n,a+28,48+s*.35,o);let c=new di(r);return c.colorSpace=Be,c}function Cu(e=7.4){let t=new Vr({map:Su(pu[hu%pu.length]),side:2}),n=new W(new xi(13,1.2),t);return n.position.y=e,n.userData.setHeadline=e=>{let n=t.map;t.map=Su(e),n.dispose()},n.userData.nextHeadline=()=>{hu=(hu+1)%pu.length,n.userData.setHeadline(pu[hu])},gu.push(n),hu=(hu+1)%pu.length,n}var wu=5.4;function Tu(e,t,n,r=-30/2,i=30/2){let a=r;for(;a<i-3;){let r=Math.min(8+t()*5,i-a),o=ll(t,r);o.rotation.y=n===-1?0:Math.PI,o.position.set(n*11.7,0,a+r/2),e.add(o),a+=r}}function Eu(e,t){Tu(e,t,-1),Tu(e,t,1)}function Du(e,t=0){for(let n of[-1,1]){let r=ul();r.rotation.y=n===-1?0:Math.PI,r.position.set(n*wu,0,t),e.add(r)}}function Ou(e,t,n=7.4){if(!bu())return;let r=Cu(n);r.position.z=t,e.add(r);let i=e.userData.onRecycle;e.userData.onRecycle=()=>{i?.(),r.userData.nextHeadline()}}function Q(e,t,n,r,i=0){return t.position.set(n,0,r),t.rotation.y=i,e.add(t),t}function ku(e){let t=new U;Eu(t,e),Du(t,-6);for(let n of[-1,1])e()<.8&&Q(t,fl(),n*wu,8+e()*4),e()<.7&&Q(t,dl(e()<.5),n*(wu-.4),-12+e()*6,n===-1?0:Math.PI),e()<.5&&Q(t,ml(),n*(wu-.7),e()*10-2,e()*Math.PI),e()<.5&&Q(t,Cl(),n*5.800000000000001,3+e()*4);return Q(t,wl(),(e()<.5?-1:1)*5.7,-9),Ou(t,2+e()*6),t}function Au(e){let t=ku(e);return Q(t,nu(),-4.800000000000001,1,Math.PI-.35),Q(t,Jl(e()<.5?`sax`:`violin`),wu-.6,-7,-.8),Q(t,Vl({coffee:!0}),wu-1.4,-5.2,-2.2),Q(t,Vl({bags:1}),wu-.2,-4.6,-2.6),t}function ju(e){let t=new U;Eu(t,e),Du(t,10);let n=e()<.5?-1:1,r=[J.umbRed,J.umbGreen,J.umbCream];for(let i=0;i<3;i++){let a=-10+i*8;Q(t,gl(r[Math.floor(e()*r.length)]),n*wu,a);for(let r=0;r<2;r++){let i=hl(),o=n*(wu+(r?.9:-.9));Q(t,i,o,a+(e()-.5),r?-Math.PI/2:Math.PI/2),e()<.7&&Q(t,Ul({coffee:r===0}),o,a+.1,r?-Math.PI/2:Math.PI/2)}}return Q(t,Vl({shirt:2236966,pants:2236966}),n*(wu-1.2),-2,n*1.2),Q(t,pl(!0),-n*wu,-8),Q(t,Cl(),-n*wu,4),Q(t,fl(),-n*wu,10),Ou(t,-4+e()*8),t}function Mu(e){let t=new U;for(let n of[-1,1])Tu(t,e,n,-30/2,-11/2-1.5),Tu(t,e,n,7,30/2);let n=new W(new hi(46,.08,11),J.asphalt);n.receiveShadow=!0,n.position.set(0,.035,0),t.add(n);for(let e of[-1,1]){let n=new W(new hi(46,.14,.5),J.curb);n.receiveShadow=!0,n.position.set(0,.07,e*5.7),t.add(n)}for(let e=-2;e<=2;e++){let n=new W(new hi(.9,.02,9.4),J.safetyStripe);n.position.set(e*2.1,.09,0),n.receiveShadow=!0,t.add(n)}let r=new W(new hi(46,.02,.18),new G({color:13218362}));r.position.set(0,.09,0),t.add(r);for(let e of[-1,1])for(let n of[-11/2-.8,6.3]){let r=new W(new _i(.12,.14,.9,8),J.ironBlack);r.castShadow=!0,r.position.set(e*6.4,.45,n),t.add(r)}Du(t,-11/2-2.5),Du(t,8),Ou(t,-11/2-1.5,7.6);let i=[];for(let n=0;n<2;n++){let r=e()<.25,a=r?Al():kl();a.visible=!1,a.position.set(-24,0,n===0?-2.6:2.6),n===1&&(a.rotation.y=Math.PI),t.add(a),i.push({obj:a,active:!1,cooldown:2+e()*5,dir:n===0?1:-1,speed:r?6:10,half:{x:r?1:1.9,z:.9},maxY:1.8})}return t.userData.hazards=i,t.userData.tick=(e,t)=>{let n=t.position.z>-80&&t.position.z<40;for(let t of i)if(t.active)t.obj.position.x+=t.dir*t.speed*e,Math.abs(t.obj.position.x)>26&&(t.active=!1,t.obj.visible=!1,t.cooldown=3+Math.random()*6);else{if(!n)continue;t.cooldown-=e,t.cooldown<=0&&(t.active=!0,t.obj.visible=!0,t.obj.position.x=t.dir===1?-24:24)}},t}function Nu(e){let t=new U;Eu(t,e),Du(t,0);for(let n of[-1,1]){for(let r=0;r<3;r++)Q(t,fl(e()<.3),n*(wu+e()*.6),-11+r*10+e()*3);e()<.7&&Q(t,pl(),n*(wu-.8),e()*16-8)}return Q(t,bl(),(e()<.5?-1:1)*(wu-.5),13,Math.PI/2+e()),Q(t,Sl(),-5.7,-4),Q(t,dl(!0),wu-.4,-2,Math.PI),Ou(t,4+e()*6),t}function Pu(e){let t=new U;Eu(t,e),Du(t,-10);let n=e()<.5?-1:1;for(let e=0;e<2;e++)Q(t,_l(),n*(wu-.6),-6+e*6,Math.PI/2);return Q(t,vl(),n*(wu-1.4),-8),Q(t,vl(),n*(wu-1.8),-2),Q(t,Vl({shirt:15233578,hat:`cap`,hatColor:15254058}),n*(wu-1),-4,1.5),Q(t,Vl({shirt:15233578,phone:!0}),n*(wu-.4),-9,-1.2),t}function Fu(e){let t=new U;Eu(t,e),Du(t,-5),Du(t,12);for(let e of[-10,10]){let n=jl(16.5,6.2);n.position.set(0,0,e),t.add(n)}Q(t,Yl(),-6.6000000000000005,2,1.35);for(let n=0;n<3;n++)Q(t,Vl({}),-4.4+e()*.5,-1+n*2.2,-1.6);if(Q(t,Dl(),6,-8,-Math.PI/2-.2),Q(t,Cl(),wu-.5,-3),bu()){let e=Cu();e.position.z=0,t.add(e),t.userData.onRecycle=()=>e.userData.nextHeadline()}return t}function Iu(e){let t=new U;for(let n of[-1,1]){let r=new W(new hi(14,.12,30),new G({color:6130244}));r.receiveShadow=!0,r.position.set(n*11,.02,0),t.add(r);let i=new W(new hi(1.6,.14,30*.8),new G({color:13287327}));i.receiveShadow=!0,i.rotation.y=n*.25,i.position.set(n*9,.03,0),t.add(i);for(let r=0;r<4;r++)Q(t,fl(e()<.25),n*(7+e()*5),-13+r*8+e()*3);Q(t,dl(!1),n*(wu-.2),-6+e()*4,n===-1?0:Math.PI)}let n=su();return n.rotation.y=0,n.position.set(-16,0,4),t.add(n),Q(t,iu(),-7,-10,-Math.PI/2+.3),Q(t,au(),7.2,6,-Math.PI/2-.3),Q(t,Ul({coffee:!0}),-5.6000000000000005,-5.9,.3),Q(t,Vl({dress:!0,hat:`brim`}),7.4,-4,-2),Q(t,Dl(),7.800000000000001,12,-Math.PI/2),Du(t,2),t}function Lu(e){let t=new U,n=ou();return n.position.set(-11.7,0,-4),t.add(n),Tu(t,e,-1,8,30/2),Tu(t,e,1),Du(t,-2),Q(t,ru(),-5,6,Math.PI+.4),Q(t,Sl(),wu-.2,-8),Q(t,dl(!0),wu-.6,-4.5,Math.PI),Q(t,fl(),5.800000000000001,-12),Q(t,fl(),-5.800000000000001,12),Q(t,ml(),-6.300000000000001,-1,.4),t}function Ru(e){let t=new U,n=cu();n.position.set(-11.7,0,-6),t.add(n),Tu(t,e,-1,1,30/2),Tu(t,e,1),Du(t,8);for(let e=0;e<3;e++)Q(t,Vl(e===1?{bags:1}:{}),-5.1000000000000005+e*.35,-3+e*1.4,2.6);return Q(t,fl(),wu,-10),Q(t,dl(!0),wu-.4,0,Math.PI),Q(t,Cl(),-6,2),Q(t,pl(!0),5.800000000000001,8),Ou(t,10),t}var zu=[[ku,2],[Au,1],[ju,2],[Mu,2],[Nu,2],[Pu,1],[Fu,1],[Iu,1],[Lu,1],[Ru,1]],Bu=class{constructor(e){this.scene=e,this.pool=[];for(let[e,t]of zu)for(let n=0;n<t;n++)this.pool.push(e(Math.random));this.chunks=[],this.spare=[],this.#e()}#e(){let e=Vu([...this.pool.keys()]);this.chunks=[],this.spare=[];for(let t=0;t<this.pool.length;t++){let n=this.pool[e[t]];t<7?(n.position.z=-t*30,this.scene.add(n),this.chunks.push(n)):this.spare.push(n)}}update(e,t){let n=1/0;for(let r of this.chunks)r.position.z+=e,r.userData.tick?.(t,r),n=Math.min(n,r.position.z);for(let e=0;e<this.chunks.length;e++){let t=this.chunks[e];if(t.position.z>30*1.2){let r=Math.floor(Math.random()*this.spare.length),i=this.spare[r];this.spare[r]=t,this.scene.remove(t),i.position.z=n-30,i.userData.onRecycle?.(),this.scene.add(i),this.chunks[e]=i,n=i.position.z}}}checkVehicleHit(e,t,n,r=0){for(let i of this.chunks){let a=i.userData.hazards;if(a)for(let o of a){if(!o.active)continue;let a=i.position.z+o.obj.position.z;if(!(Math.abs(a-r)>o.half.z+.3)&&!(Math.abs(o.obj.position.x-e)>o.half.x+.32)&&t<o.maxY&&n>0)return o}}return null}reset(){for(let e of this.chunks)this.scene.remove(e);for(let e of this.pool)if(e.userData.hazards)for(let t of e.userData.hazards)t.active=!1,t.obj.visible=!1,t.cooldown=2+Math.random()*5;this.#e()}};function Vu(e){for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}var Hu=[-2.1,0,2.1];function Uu(e,t){return{build:()=>Gl(e),kind:`jump`,weight:t,half:{x:.6,z:.45},minY:0,maxY:e===`small`?.75:1,move:`wander`}}function Wu(e,t){return{build:()=>{let t=new U,n=Vl({scale:1.3});t.add(n);let r=Gl(e);r.position.set(.95,0,.35),r.rotation.y=Math.PI/2,t.add(r);let i=new W(new hi(1,.025,.025),new G({color:2367775}));return i.position.set(.5,1,.18),i.rotation.set(0,-.3,-.55),t.add(i),t.userData.walker=n,t.userData.dog=r,t},kind:`solid`,weight:t,half:{x:.42,z:.35},minY:0,maxY:2.5,move:`walk`,sub:[{dx:-.95,dz:-.35,half:{x:.6,z:.45},minY:0,maxY:e===`small`?.75:1}]}}function Gu(e,t){return{build:()=>Vl({...e,scale:1.3}),kind:`solid`,weight:t,half:{x:.42,z:.35},minY:0,maxY:2.5,move:`walk`}}var Ku=[{build:xl,kind:`jump`,weight:3,half:{x:.85,z:.7},minY:0,maxY:.85},{build:ml,kind:`jump`,weight:2,half:{x:.6,z:.55},minY:0,maxY:1.05},{build:yl,kind:`jump`,weight:2,half:{x:.55,z:.55},minY:0,maxY:.95},{build:bl,kind:`jump`,weight:2,half:{x:.65,z:.35},minY:0,maxY:1},{build:hl,kind:`jump`,weight:1,half:{x:.5,z:.5},minY:0,maxY:1},{build:Cl,kind:`jump`,weight:2,half:{x:.45,z:.45},minY:0,maxY:1},{build:wl,kind:`jump`,weight:2,half:{x:.4,z:.4},minY:0,maxY:1.05},{build:_l,kind:`jump`,weight:1,half:{x:.9,z:.35},minY:0,maxY:1},Wu(`black`,2),Wu(`golden`,2),Wu(`shaggy`,1),Wu(`brown`,1),Uu(`small`,1),{build:gl,kind:`solid`,weight:2,half:{x:.85,z:.85},minY:0,maxY:2.4},{build:El,kind:`solid`,weight:2,half:{x:.5,z:.45},minY:0,maxY:2,escort:!0},Gu({mailbag:!0,hat:`cap`,hatColor:3100019,shirt:4876938,pants:3495534},2),Gu({bags:2},2),Gu({phone:!0},1),Gu({afro:!0,basketball:!0,shirt:15233578,pants:2894896,skin:7293488},2),{build:Tl,kind:`slide`,weight:3,half:{x:1.05,z:1.1},minY:1.35,maxY:2.7}],qu=3,Ju=class{constructor(e){this.scene=e,this.pool=[];for(let t of Ku)for(let n=0;n<qu;n++){let n=t.build(),r=new U;if(r.add(n),t.escort){let e=Vl({shirt:7031343,hat:`cap`,hatColor:7031343});e.position.set(0,0,.85),r.add(e),r.userData.escortPerson=e}r.visible=!1,e.add(r),this.pool.push({obj:r,inner:n,type:t,active:!1,lane:0,wanderT:0})}this.active=[],this.nextSpawnZ=-60,this.byKind={};for(let e of this.pool)(this.byKind[e.type.kind]||=[]).push(e)}reset(){for(let e of this.pool)e.active=!1,e.obj.visible=!1;this.active=[],this.nextSpawnZ=-60}acquire(e){let t=this.pool.filter(t=>!t.active&&(e===null||t.type.kind===e));if(!t.length)return null;let n=t.reduce((e,t)=>e+t.type.weight,0),r=Math.random()*n;for(let e of t)if(r-=e.type.weight,r<=0)return e;return t[t.length-1]}spawnGap(e){return 20-e*8+Math.random()*9}spawnRow(e,t){let n=Yu([0,1,2]),r=Math.random()<t*.7?2:1;for(let i=0;i<r;i++){let r=Math.random(),a;a=i>0?`jump`:r<.2&&t>.2?`slide`:r<.42&&t>.1?`solid`:`jump`;let o=this.acquire(a)||this.acquire(null);if(!o)return;o.active=!0,o.lane=n[i],o.wanderT=Math.random()*6,o.baseX=Hu[n[i]],o.obj.position.set(o.baseX,0,e),o.type.move===`walk`?o.obj.rotation.y=Math.PI:o.type.kind===`slide`?o.obj.rotation.y=Math.PI/2:o.type.escort?o.obj.rotation.y=Math.PI:o.obj.rotation.y=Math.random()*Math.PI*2,o.obj.visible=!0,this.active.push(o)}}update(e,t,n,r){for(let r=this.active.length-1;r>=0;r--){let i=this.active[r];i.obj.position.z+=e,i.type.move===`wander`?(i.wanderT+=t,i.obj.position.x=i.baseX+Math.sin(i.wanderT*1.4)*.55,i.obj.rotation.y=Math.cos(i.wanderT*1.4)>=0?0:Math.PI,ql(i.inner,n,6)):i.type.move===`walk`?(i.obj.position.z+=1.6*t,Hl(i.inner.userData.walker||i.inner,n,6),i.inner.userData.dog&&ql(i.inner.userData.dog,n,7)):i.type.escort&&(i.obj.position.z+=1.2*t,Hl(i.obj.userData.escortPerson,n,5)),i.obj.position.z>12&&(i.active=!1,i.obj.visible=!1,this.active.splice(r,1))}this.nextSpawnZ+=e,this.nextSpawnZ>-55&&(this.spawnRow(-140+Math.random()*10,r),this.nextSpawnZ=-55-this.spawnGap(r))}checkCollision(e,t,n,r=.32,i=.3,a=0){for(let o of this.active){let s=o.obj.position.z,c=o.obj.position.x;if(Math.abs(s-a)<=o.type.half.z+i&&Math.abs(c-e)<=o.type.half.x+r&&t<o.type.maxY&&n>o.type.minY)return o;if(o.type.sub){for(let l of o.type.sub)if(Math.abs(s+l.dz-a)<=l.half.z+i&&Math.abs(c+l.dx-e)<=l.half.x+r&&t<l.maxY&&n>l.minY)return o}}return null}};function Yu(e){for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}var Xu=26,Zu=8.6,Qu=14,$u=.62,ed=3.2;function td(e){return new G({color:e})}function nd(e,t,n,r,i,a,o){let s=new W(new hi(e,t,n),r);return s.position.set(i,a,o),s.castShadow=!0,s}function rd(e,t,n,r,i,a,o){let s=new U;s.position.set(i,a,o);let c=new W(new hi(e,t,n),r);return c.position.y=-t/2,c.castShadow=!0,s.add(c),s}var id=class{constructor(e,t){this.group=new U,this.body=new U,this.group.add(this.body),e.add(this.group),this.setCharacter(t),this.reset()}setCharacter(e){this.spec=e,this.body.clear();let t=td(e.skin),n=td(e.shirt),r=td(e.pants),i=td(e.shoes);if(e.dress){let e=new W(new _i(.22,.46,.9,8),n);e.position.y=.9,e.castShadow=!0,this.body.add(e),this.body.add(nd(.44,.38,.27,n,0,1.4,0))}else{if(this.body.add(nd(.5,.62,.3,n,0,1.05,0)),e.jacket){let t=td(e.jacket);this.body.add(nd(.56,.4,.34,t,0,1.18,0))}if(e.flannel){let t=td(e.flannel);this.body.add(nd(.52,.08,.32,t,0,1.2,0)),this.body.add(nd(.52,.08,.32,t,0,.98,0)),this.body.add(nd(.1,.62,.32,t,-.14,1.05,0)),this.body.add(nd(.1,.62,.32,t,.14,1.05,0))}}let a=new W(new Si(.21,10,8),t);if(a.position.set(0,1.6,0),a.castShadow=!0,this.body.add(a),e.hat===`cap`){let t=td(e.hatColor);this.body.add(nd(.34,.06,.42,t,0,1.68,-.06)),this.body.add(nd(.34,.16,.34,t,0,1.76,.02))}else if(e.hat===`brim`){let t=td(e.hatColor),n=new W(new _i(.44,.44,.05,12),t);n.position.y=1.72,n.castShadow=!0,this.body.add(n);let r=new W(new _i(.2,.22,.16,12),t);r.position.y=1.81,this.body.add(r)}else if(e.hat===`beanie`){let t=new W(new Si(.22,10,8),td(e.hatColor));t.scale.y=.75,t.position.y=1.73,this.body.add(t)}else if(e.hair){let t=new W(new Si(.215,10,8),td(e.hair));t.scale.y=.7,t.position.y=1.72,this.body.add(t),e.dress&&this.body.add(nd(.1,.5,.14,td(e.hair),0,1.5,.18))}if(e.headphones){let e=td(2236966);this.body.add(nd(.06,.12,.1,e,-.22,1.6,0)),this.body.add(nd(.06,.12,.1,e,.22,1.6,0)),this.body.add(nd(.46,.05,.08,e,0,1.78,0))}e.backpack&&this.body.add(nd(.4,.5,.2,td(e.backpack),0,1.15,.26));let o=e.dress?t:r,s=e.dress?.45:.55,c=e.dress?.5:.72;this.legL=rd(.16,s,.18,o,-.14,c,0),this.legR=rd(.16,s,.18,o,.14,c,0),this.armL=rd(.12,.5,.14,e.dress?t:n,-.34,1.3,0),this.armR=rd(.12,.5,.14,e.dress?t:n,.34,1.3,0);let l=nd(.16,.1,.28,i,0,-s+.03,.05),u=nd(.16,.1,.28,i,0,-s+.03,.05);this.legL.add(l),this.legR.add(u),this.body.add(this.legL,this.legR,this.armL,this.armR),this.jetpack=new U;let d=td(7173760);for(let e of[-.13,.13]){let t=new W(new _i(.11,.11,.5,10),d);t.position.set(e,1.15,.3),this.jetpack.add(t)}this.flameL=new W(new vi(.09,.3,8),td(16752686)),this.flameL.rotation.x=Math.PI,this.flameL.position.set(-.13,.82,.3),this.flameR=this.flameL.clone(),this.flameR.position.x=.13,this.jetpack.add(this.flameL,this.flameR),this.jetpack.visible=!1,this.body.add(this.jetpack)}reset(){this.lane=1,this.x=Hu[1],this.y=0,this.vy=0,this.grounded=!0,this.sliding=0,this.flying=0,this.runPhase=0,this.zOffset=0,this.group.position.set(this.x,0,0),this.group.rotation.set(0,Math.PI,0),this.body.rotation.set(0,0,0),this.body.position.y=0,this.body.scale.set(1,1,1),this.body.visible=!0,this.jetpack.visible=!1}moveLane(e){this.lane=Ot.clamp(this.lane+e,0,2)}jump(){this.flying>0||this.grounded&&(this.vy=Zu,this.grounded=!1,this.sliding=0)}slide(){this.flying>0||(this.grounded?this.sliding=$u:(this.vy=-18,this.sliding=$u*.7))}startFlight(e){this.flying=e,this.sliding=0,this.jetpack.visible=!0}update(e,t){let n=Hu[this.lane]-this.x,r=Math.sign(n)*Math.min(Math.abs(n),Qu*e);this.x+=r,this.flying>0?(this.flying-=e,this.y+=(ed-this.y)*Math.min(1,e*4),this.vy=0,this.grounded=!1,this.flying<=0&&(this.jetpack.visible=!1)):this.grounded||(this.vy-=Xu*e,this.y+=this.vy*e,this.y<=0&&(this.y=0,this.vy=0,this.grounded=!0)),this.sliding>0&&(this.sliding-=e),this.group.position.set(this.x,this.y,this.zOffset),this.runPhase+=e*(6+t*.55);let i=Math.sin(this.runPhase);if(this.body.scale.set(1,1,1),this.flying>0){this.body.rotation.x=.35,this.body.position.y=0,this.legL.rotation.x=.25,this.legR.rotation.x=.15,this.armL.rotation.x=-2.6,this.armR.rotation.x=-2.6;let e=.22+Math.random()*.16;this.flameL.scale.set(1,e*4,1),this.flameR.scale.set(1,e*4,1)}else this.grounded?this.sliding>0?(this.body.scale.set(1,.52,1),this.body.rotation.x=-.55,this.body.position.y=.1,this.legL.rotation.x=-1.4,this.legR.rotation.x=-1.1,this.armL.rotation.x=-2.4,this.armR.rotation.x=-2.2):(this.body.rotation.x=.14,this.body.position.y=Math.abs(Math.cos(this.runPhase))*.06,this.legL.rotation.x=i*1,this.legR.rotation.x=-i*1,this.armL.rotation.x=-i*.9,this.armR.rotation.x=i*.9):(this.legL.rotation.x=.5,this.legR.rotation.x=-.4,this.armL.rotation.x=-.9,this.armR.rotation.x=.7,this.body.rotation.x=.12,this.body.position.y=0);this.body.rotation.z=Ot.clamp(-n*.18,-.3,.3)}get bottom(){return this.y+.15}get top(){return this.sliding>0?this.y+.85:this.y+1.85}},ad=26;function od({left:e,right:t,up:n,down:r,anyKey:i}){let a=0,o=0,s=!1;window.addEventListener(`touchstart`,e=>{let t=e.changedTouches[0];a=t.clientX,o=t.clientY,performance.now(),s=!0},{passive:!0}),window.addEventListener(`touchend`,c=>{if(!s||(s=!1,c.target.closest?.(`button, a, input`)))return;let l=c.changedTouches[0],u=l.clientX-a,d=l.clientY-o,f=Math.abs(u),p=Math.abs(d);if(Math.max(f,p)<ad){i?.();return}f>p?(u>0?t:e)():(d>0?r:n)()},{passive:!0}),window.addEventListener(`keydown`,a=>{if(!a.target.closest?.(`input, textarea`))switch(a.code){case`ArrowLeft`:case`KeyA`:e();break;case`ArrowRight`:case`KeyD`:t();break;case`ArrowUp`:case`KeyW`:case`Space`:n(),a.preventDefault();break;case`ArrowDown`:case`KeyS`:r(),a.preventDefault();break;default:i?.()}})}function sd(e,t={}){return new G({color:e,fog:!1,...t})}var cd={brick:sd(9847338),brickDark:sd(8271650),white:sd(16118246),whiteShade:sd(14998986),roof:sd(4868690),spire:sd(15328469),clock:sd(16644850),clockHand:sd(2829099),door:sd(2574893),gold:sd(14266940,{emissive:4864528}),window:sd(14674154)};function ld(e,t,n,r,i=0,a=0,o=0){let s=new W(new hi(e,t,n),r);return s.position.set(i,a,o),s}function ud(){let e=new U;e.add(ld(11,9,16,cd.brick,0,4.5,-6)),e.add(ld(11.4,.7,.7,cd.white,0,9,1.6));let t=new W(new _i(.1,6.4,3.2,3,1),cd.white);t.rotation.y=Math.PI,t.scale.z=.28,t.position.set(0,10.6,1.3),e.add(t);let n=new W(new _i(.15,8.1,3.4,3,1),cd.roof);n.rotation.y=Math.PI,n.scale.z=2.1,n.position.set(0,10.7,-6),e.add(n),e.add(ld(1.6,3,.3,cd.door,0,1.5,2.1)),e.add(ld(1.2,2.6,.3,cd.door,-3.4,1.3,2.1)),e.add(ld(1.2,2.6,.3,cd.door,3.4,1.3,2.1)),e.add(ld(1.4,2.2,.3,cd.window,-3.4,6.2,2.05)),e.add(ld(1.4,2.2,.3,cd.window,3.4,6.2,2.05)),e.add(ld(1.6,2.4,.3,cd.window,0,6.4,2.05)),e.add(ld(4.6,8,4.6,cd.brickDark,0,12,-1)),e.add(ld(4.9,.6,4.9,cd.white,0,16.2,-1)),e.add(ld(4.2,3.4,4.2,cd.white,0,18.2,-1));for(let[t,n,r]of[[0,2.15,0],[0,-2.15,0],[2.15,0,Math.PI/2],[-2.15,0,Math.PI/2]]){let i=new W(new _i(1.05,1.05,.15,20),cd.clock);i.rotation.x=Math.PI/2,i.rotation.z=r,i.position.set(t,18.3,-1+n),e.add(i);let a=ld(.12,.75,.06,cd.clockHand,t*1.04,18.55,-1+n*1.04);a.rotation.z=.5,e.add(a)}e.add(ld(4.6,.5,4.6,cd.whiteShade,0,20.1,-1));let r=new W(new _i(1.9,2.1,3.4,8),cd.white);r.position.set(0,22,-1),e.add(r);for(let t=0;t<8;t++){let n=t/8*Math.PI*2+Math.PI/8,r=ld(.55,1.8,.2,cd.roof,Math.cos(n)*1.95,22,-1+Math.sin(n)*1.95);r.rotation.y=-n+Math.PI/2,e.add(r)}let i=new W(new _i(2.3,2.3,.4,8),cd.whiteShade);i.position.set(0,23.9,-1),e.add(i);let a=new W(new _i(1.15,1.35,2.2,8),cd.white);a.position.set(0,25.2,-1),e.add(a);let o=new W(new vi(1.35,6.5,8),cd.spire);o.position.set(0,29.5,-1),e.add(o);let s=new W(new _i(.05,.05,1.6,6),cd.gold);s.position.set(0,33.4,-1),e.add(s);let c=new W(new Si(.22,8,6),cd.gold);c.position.set(0,33,-1),e.add(c);let l=new W(new hi(30,.2,12),sd(5603391));l.position.set(0,.05,6),e.add(l);let u=new W(new hi(60,.22,4),sd(4999752));u.position.set(0,.05,13.6),e.add(u);let d=[sd(9321266),sd(3495534),sd(13617336)],f=new U,p=new W(new hi(3.2,.55,1.4),d[0]);p.position.y=.55,f.add(p);let m=new W(new hi(1.7,.5,1.3),d[0]);m.position.set(-.1,1.05,0),f.add(m);let h=new W(new hi(1.5,.35,1.15),sd(9417412));return h.position.set(-.1,1.08,0),f.add(h),f.position.set(-40,.15,13.6),e.add(f),e.userData.passingCar=f,e.userData.carMats=d,e.userData.carBody=[p,m],e.scale.setScalar(2.2),e}function dd(e,t){let n=e.userData.passingCar;if(!n)return;let r=t%14/14;if(r<.4)n.visible=!0,n.position.x=-40+r/.4*80;else if(n.visible=!1,!e.userData.swapped&&r>.5){let n=e.userData.carMats,r=n[Math.floor(t/14)%n.length];for(let t of e.userData.carBody)t.material=r;e.userData.swapped=!0}r<.5&&(e.userData.swapped=!1)}function fd(){let e=new U,t=new Vr({color:16777215,fog:!1,transparent:!0,opacity:.92}),n=new bi(1,1),r=[];for(let i=0;i<7;i++){let a=new U,o=3+Math.floor(Math.random()*3);for(let e=0;e<o;e++){let r=new W(n,t),i=3.5+Math.random()*4;r.scale.set(i*(1.2+Math.random()*.8),i*.55,i),r.position.set(e*4-o*2+Math.random()*2,(Math.random()-.5)*2,(Math.random()-.5)*3),a.add(r)}let s=i%2==0?-1:1;a.position.set(s*(16+Math.random()*30),52+Math.random()*26,(Math.random()-.5)*40),a.userData.driftSpeed=.4+Math.random()*.6,a.userData.baseX=a.position.x,r.push(a),e.add(a)}return e.userData.clouds=r,e}function pd(e,t){for(let n of e.userData.clouds)n.position.x=n.userData.baseX+Math.sin(t*.08*n.userData.driftSpeed+n.userData.baseX)*6}var md=new G({color:15249978,emissive:7032080}),hd=new G({color:16117986}),gd=new G({color:13081176});new G({color:9067052}),new G({color:11549232});var _d=new G({color:12729134,emissive:5246986}),vd=new G({color:15263455});new G({color:7173760,emissive:1843494}),new G({color:16752686,emissive:13393680});function yd(){let e=new W(new _i(.3,.3,.07,14),md);e.rotation.x=Math.PI/2;let t=new U;t.add(e);let n=new W(new gi(.13,5),new G({color:11565080}));return n.position.z=.045,t.add(n),t}function bd(){let e=new U,t=new W(new vi(.2,.5,8),gd);t.rotation.x=Math.PI,t.position.y=-.2,e.add(t);let n=new W(new Si(.21,8,6),hd);n.position.y=.12,e.add(n);let r=new W(new Si(.15,8,6),hd);r.position.y=.3,e.add(r);let i=new W(new vi(.1,.22,8),hd);return i.position.y=.46,e.add(i),e}function xd(){let e=new U,t=new W(new Ci(.26,.09,8,12,Math.PI),_d);t.rotation.z=Math.PI,e.add(t);for(let t of[-.26,.26]){let n=new W(new hi(.18,.16,.18),vd);n.position.set(t,.22,0),e.add(n)}return e}var Sd={coin:{build:yd,value:1,pool:30},creemee:{build:bd,power:`fly`,pool:2},magnet:{build:xd,power:`magnet`,pool:2}},Cd=class{constructor(e){this.scene=e,this.pool=[];for(let[t,n]of Object.entries(Sd))for(let r=0;r<n.pool;r++){let r=n.build();r.visible=!1,e.add(r),this.pool.push({obj:r,kind:t,cfg:n,active:!1})}this.nextSpawnZ=0,this.sincePower=0}reset(){for(let e of this.pool)e.active=!1,e.obj.visible=!1;this.nextSpawnZ=-30,this.sincePower=0}acquire(e){return this.pool.find(t=>!t.active&&t.kind===e)||null}laneBlocked(e,t,n,r){if(!r)return!1;let i=Hu[e];for(let e of r.active){let r=e.obj.position.z;if(!(r<n-2.5||r>t+2.5)&&(Math.abs(e.obj.position.x-i)<1.3||e.type.sub&&Math.abs(e.obj.position.x+e.type.sub[0].dx-i)<1.2))return!0}return!1}spawnLine(e,t){let n=4+Math.floor(Math.random()*3),r=e-(n+1)*2.2,i=[0,1,2].sort(()=>Math.random()-.5).find(n=>!this.laneBlocked(n,e,r,t));if(i===void 0)return;this.sincePower+=1;let a=null,o=Math.random();this.sincePower>4&&o<.24&&(a=this.acquire(o<.12?`magnet`:`creemee`),a&&(this.sincePower=0));let s=e;a&&(a.active=!0,a.obj.position.set(Hu[i],1.05,s),a.obj.visible=!0,s-=2.2);for(let e=0;e<n;e++){let t=this.acquire(`coin`);if(!t)break;t.active=!0,t.obj.position.set(Hu[i],1.05,s-e*2),t.obj.visible=!0}}update(e,t,n,r,i,a){let o=[];this.nextSpawnZ+=e,this.nextSpawnZ>-40&&(this.spawnLine(-135-Math.random()*8,a),this.nextSpawnZ=-40-(14+Math.random()*22));let s=r.x,c=r.y+1;for(let r of this.pool){if(!r.active)continue;let l=r.obj;l.position.z+=e,l.rotation.y+=t*3;let u=1.05+Math.sin(n*4+l.position.z*.5)*.08;if((l.userData.lift===void 0||!i)&&(l.userData.lift=0),l.position.y=u+l.userData.lift,i){let e=s-l.position.x,n=-l.position.z;Math.hypot(e,n)<7&&l.position.z>-10&&(l.position.x+=e*Math.min(1,t*8),l.position.z+=(0-l.position.z)*Math.min(1,t*6),l.userData.lift+=(c-l.position.y)*Math.min(1,t*8))}if(a&&r.kind===`coin`&&a.active.some(e=>Math.abs(e.obj.position.z-l.position.z)<e.type.half.z+1&&Math.abs(e.obj.position.x-l.position.x)<e.type.half.x+.8)){r.active=!1,l.visible=!1;continue}if(l.position.z>8){r.active=!1,l.visible=!1;continue}Math.abs(l.position.z)<.9&&Math.abs(l.position.x-s)<.75&&Math.abs(l.position.y-c)<1.4&&(r.active=!1,l.visible=!1,o.push(r))}return o}},wd=[{id:`sam`,name:`Sam`,emoji:`🧢`,skin:15250570,shirt:3107663,pants:3882826,shoes:15722972,hat:`cap`,hatColor:11549232},{id:`june`,name:`June`,emoji:`👒`,skin:14262894,shirt:14714447,pants:14714447,shoes:15787992,hat:`brim`,hatColor:14997168,dress:!0,hair:4864035},{id:`marcus`,name:`Marcus`,emoji:`🎧`,skin:7293488,shirt:13214254,pants:2894896,shoes:16777215,hat:`beanie`,hatColor:3100019,jacket:4013380,headphones:!0},{id:`brook`,name:`Brook`,emoji:`🥾`,skin:13209186,shirt:9321266,pants:6047282,shoes:4864035,hat:null,hair:9071162,flannel:6037274,backpack:3039043}];function Td(){let e=localStorage.getItem(`csr-char`);return wd.find(t=>t.id===e)||wd[0]}function Ed(e){localStorage.setItem(`csr-char`,e)}var Dd=null,Od=null,kd=localStorage.getItem(`csr-mute`)===`on`;function Ad(){return Dd||(Dd=new(window.AudioContext||window.webkitAudioContext),Od=Dd.createGain(),Od.gain.value=kd?0:.5,Od.connect(Dd.destination)),Dd}function jd(){let e=Ad();e.state===`suspended`&&e.resume()}function Md(){return kd}function Nd(e){kd=e,localStorage.setItem(`csr-mute`,e?`on`:`off`),Od&&(Od.gain.value=e?0:.5)}function Pd(e,t,n=`sine`,r=.2,i=null,a=0){let o=Ad();if(o.state===`suspended`)return;let s=o.currentTime+a,c=o.createOscillator(),l=o.createGain();return c.type=n,c.frequency.setValueAtTime(e,s),i&&c.frequency.exponentialRampToValueAtTime(i,s+t),l.gain.setValueAtTime(1e-4,s),l.gain.exponentialRampToValueAtTime(r,s+.012),l.gain.exponentialRampToValueAtTime(1e-4,s+t),c.connect(l).connect(Od),c.start(s),c.stop(s+t+.02),c}function Fd(e,t,n=.25,r=0){let i=Ad();if(i.state===`suspended`)return;let a=i.currentTime+r,o=Math.max(1,Math.floor(i.sampleRate*e)),s=i.createBuffer(1,o,i.sampleRate),c=s.getChannelData(0);for(let e=0;e<o;e++)c[e]=(Math.random()*2-1)*(1-e/o);let l=i.createBufferSource();l.buffer=s;let u=i.createBiquadFilter();u.type=`lowpass`,u.frequency.value=t;let d=i.createGain();d.gain.setValueAtTime(n,a),d.gain.exponentialRampToValueAtTime(1e-4,a+e),l.connect(u).connect(d).connect(Od),l.start(a)}var Id=null;function Ld(){let e=Ad();if(Id||e.state===`suspended`)return;let t=e.sampleRate,n=e.createBuffer(1,t,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<t;e++)r[e]=Math.random()*2-1;let i=e.createBufferSource();i.buffer=n,i.loop=!0;let a=e.createBiquadFilter();a.type=`bandpass`,a.frequency.value=420,a.Q.value=.7;let o=e.createGain();o.gain.setValueAtTime(1e-4,e.currentTime),o.gain.exponentialRampToValueAtTime(.22,e.currentTime+.15);let s=e.createOscillator();s.frequency.value=26;let c=e.createGain();c.gain.value=120,s.connect(c).connect(a.frequency),i.connect(a).connect(o).connect(Od),i.start(),s.start(),Id={src:i,g:o,lfo:s}}function Rd(){if(!Id)return;let e=Ad();Id.g.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.25);let t=Id;setTimeout(()=>{try{t.src.stop(),t.lfo.stop()}catch{}},350),Id=null}var zd=null;function Bd(){let e=Ad();if(zd||e.state===`suspended`)return;let t=e.createOscillator();t.type=`sine`,t.frequency.value=190;let n=e.createOscillator();n.frequency.value=7;let r=e.createGain();r.gain.value=24,n.connect(r).connect(t.frequency);let i=e.createGain();i.gain.setValueAtTime(1e-4,e.currentTime),i.gain.exponentialRampToValueAtTime(.06,e.currentTime+.2),t.connect(i).connect(Od),t.start(),n.start(),zd={osc:t,lfo:n,g:i}}function Vd(){if(!zd)return;let e=Ad();zd.g.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.2);let t=zd;setTimeout(()=>{try{t.osc.stop(),t.lfo.stop()}catch{}},300),zd=null}var Hd=new Set;function Ud(...e){let t=Pd(...e);t&&(Hd.add(t),t.addEventListener(`ended`,()=>Hd.delete(t),{once:!0}))}function Wd(){for(let e of Hd)try{e.stop()}catch{}Hd.clear()}var Gd={click:()=>Pd(620,.06,`square`,.1),jump:()=>Pd(280,.2,`sine`,.22,560),slide:()=>Fd(.22,900,.2),coin:()=>{Pd(1320,.07,`square`,.1),Pd(1660,.1,`square`,.1,null,.06)},bonus:()=>{Pd(880,.09,`triangle`,.16),Pd(1100,.09,`triangle`,.16,null,.08),Pd(1470,.16,`triangle`,.16,null,.16)},magnetPickup:()=>{Pd(220,.3,`sawtooth`,.14,880),Bd()},magnetEnd:()=>Vd(),jetpackPickup:()=>{Pd(300,.35,`sawtooth`,.16,900),Ld()},jetpackEnd:()=>{Rd(),Pd(700,.3,`sine`,.12,220)},hit:()=>{Fd(.3,320,.4),Pd(150,.3,`sawtooth`,.28,55)},nearMiss:()=>{Pd(520,.09,`triangle`,.1,760),Pd(880,.12,`triangle`,.08,null,.08)},bark:()=>{Pd(240,.07,`square`,.26,150),Pd(210,.09,`square`,.26,130,.12)},best:()=>{Wd(),Ud(523,.16,`triangle`,.14),Ud(659,.16,`triangle`,.14,null,.14),Ud(784,.18,`triangle`,.15,null,.28),Ud(1047,.34,`triangle`,.16,null,.43)},gameover:()=>{Pd(440,.18,`triangle`,.2,null,0),Pd(349,.18,`triangle`,.2,null,.18),Pd(262,.4,`triangle`,.2,null,.36)},stopLoops:()=>{Rd(),Vd(),Wd()}},Kd=`https://jnouvwxomrcffqwilqkq.supabase.co/`,qd=`sb_publishable_RkMJQopffWlV6DSwCRkndQ_Xw6GJMf3`,Jd=`church-street-runner`;function Yd(){return!!qd}function Xd(e,t){let n=localStorage.getItem(e);return n||(n=t(),localStorage.setItem(e,n)),n}function Zd(){return Xd(`btown-player-id`,()=>crypto.randomUUID())}function Qd(){return Xd(`btown-player-token`,()=>[...crypto.getRandomValues(new Uint8Array(16))].map(e=>e.toString(16).padStart(2,`0`)).join(``))}function $d(){return localStorage.getItem(`btown-player-name`)||``}function ef(e){localStorage.setItem(`btown-player-name`,e.trim().slice(0,20))}async function tf(e,t){let n={apikey:qd,"Content-Type":`application/json`};qd.startsWith(`eyJ`)&&(n.Authorization=`Bearer ${qd}`);let r=await fetch(`${Kd.replace(/\/+$/,``)}/rest/v1/rpc/${e}`,{method:`POST`,headers:n,body:JSON.stringify(t)});if(!r.ok)throw Error(`${e} failed: ${r.status}`);let i=await r.text();return i?JSON.parse(i):null}function nf(e){let t=new Date;return t.setDate(1),t.setMonth(t.getMonth()+e),t}function rf(e=0){let t=nf(e);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`}function af(e=0){return nf(e).toLocaleString(`en-US`,{month:`long`})}async function of(e){!Yd()||!$d()||e<=0||await tf(`submit_score`,{p_game:Jd,p_player:Zd(),p_token:Qd(),p_name:$d(),p_score:Math.floor(e)})}async function sf(e){ef(e),Yd()&&await tf(`rename_player`,{p_player:Zd(),p_token:Qd(),p_name:$d()})}async function cf(e=0){return Yd()&&await tf(`get_leaderboard`,{p_game:Jd,p_month:rf(e)})||[]}var lf=document.getElementById(`app`),uf=new Xc({antialias:window.devicePixelRatio<2,powerPreference:`high-performance`});uf.setPixelRatio(Math.min(window.devicePixelRatio,2)),uf.setSize(window.innerWidth,window.innerHeight),uf.shadowMap.enabled=!0,uf.shadowMap.type=2,uf.outputColorSpace=Be,lf.appendChild(uf.domElement);var df=new Nn(12441575),ff=new In;ff.background=df,ff.fog=new Fn(df,35,130);var pf=new da(58,window.innerWidth/window.innerHeight,.1,400);pf.position.set(0,4.6,7.2),pf.lookAt(0,2.2,-20);var mf=new $i(13624560,10123868,.95);ff.add(mf);var hf=new ma(16773590,1.5);hf.position.set(-9,34,-12),hf.castShadow=!0,hf.shadow.mapSize.set(1024,1024),hf.shadow.camera.left=-24,hf.shadow.camera.right=24,hf.shadow.camera.top=30,hf.shadow.camera.bottom=-30,hf.shadow.camera.near=2,hf.shadow.camera.far=110,hf.shadow.bias=-4e-4,hf.shadow.camera.updateProjectionMatrix(),hf.target.position.set(0,0,-18),ff.add(hf,hf.target);var gf=Zc(256,256),_f=6;gf.repeat.set(20/_f,260/_f);var vf=new W(new xi(20,260),new G({map:gf}));vf.rotation.x=-Math.PI/2,vf.position.z=-100,vf.receiveShadow=!0,ff.add(vf);var yf=new G({color:12169892});for(let e of[-3.4,3.4]){let t=new W(new xi(.5,260),yf);t.rotation.x=-Math.PI/2,t.position.set(e,.01,-100),t.receiveShadow=!0,ff.add(t)}vu().then(()=>{let e=yu(),t=document.getElementById(`newsletterLink`);t.href=e.url,t.textContent=`📰 Read "${e.title}" →`});var bf=new Bu(ff),xf=new Ju(ff),Sf=Td(),$=new id(ff,Sf),Cf=new Zl(ff,10),wf=new Cd(ff),Tf=ud();Tf.position.set(0,0,-165),ff.add(Tf);var Ef=fd();Ef.position.z=-165,ff.add(Ef);var Df=Gl(`black`);Df.scale.setScalar(1.25),Df.rotation.y=Math.PI/2,Df.visible=!1,ff.add(Df);var Of=e=>document.getElementById(e),kf=Of(`score`),Af=Of(`best`),jf=Of(`coins`),Mf=Of(`lives`),Nf=Of(`start`),Pf=Of(`gameover`),Ff=Of(`finalScore`),If=Of(`bestLine`),Lf=Of(`coinLine`),Rf=Of(`power`),zf=Of(`livesBadge`),Bf=Of(`effects`),Vf=Of(`impactFlash`),Hf=Of(`callout`),Uf=Of(`bestConfetti`),Wf=window.matchMedia(`(prefers-reduced-motion: reduce)`),Gf={easy:{base:11,accel:.42,max:24},hard:{base:13.5,accel:.75,max:30}},Kf=localStorage.getItem(`csr-mode`)||`easy`,qf=3,Jf=`ready`,Yf=Gf[Kf].base,Xf=0,Zf=0,Qf=Number(localStorage.getItem(`csr-best`)||0);Af.textContent=Math.floor(Qf);var $f=2,ep=0,tp=0,np=0,rp=0,ip=0,ap=0,op=new Map,sp=new Set,cp=0,lp=0,up=0,dp=0,fp=0,pp=new Set,mp=40;function hp(e,t){let n=cp,r=window.setTimeout(()=>{pp.delete(r),n===cp&&e()},t);pp.add(r)}function gp(){cp+=1;for(let e of pp)window.clearTimeout(e);pp.clear(),Bf.querySelectorAll(`.transient-effect`).forEach(e=>e.remove()),Uf.replaceChildren(),lp=0,up+=1,dp+=1,fp+=1,Hf.classList.remove(`active`),Hf.textContent=``,Vf.classList.remove(`active`),kf.classList.remove(`score-pop`),zf.classList.remove(`hit`),If.classList.remove(`fanfare`),op=new Map,sp=new Set}function _p(e){let t=e.clone().project(pf);return{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}function vp(e,t,n,r,i,a={},o=``,s=!1){if(Wf.matches&&!s||lp>=mp)return;let c=document.createElement(`span`);c.className=`particle transient-effect ${t}`,c.textContent=o,c.setAttribute(`aria-hidden`,`true`),c.style.setProperty(`--x`,typeof n==`number`?`${n}px`:n),c.style.setProperty(`--y`,typeof r==`number`?`${r}px`:r);for(let[e,t]of Object.entries(a))c.style.setProperty(e,t);e.appendChild(c),lp+=1,hp(()=>{c.isConnected&&(c.remove(),lp=Math.max(0,lp-1))},i)}function yp(){let e=++dp;kf.classList.remove(`score-pop`),kf.offsetWidth,kf.classList.add(`score-pop`),hp(()=>{e===dp&&kf.classList.remove(`score-pop`)},220)}function bp(e){let t=++up;Hf.textContent=e,Hf.classList.remove(`active`),Hf.offsetWidth,Hf.classList.add(`active`),hp(()=>{t===up&&(Hf.classList.remove(`active`),Hf.textContent=``)},760)}function xp(e,t){let{x:n,y:r}=_p(t);vp(Bf,`float-score`,n,r-12,260,{},`+${e}`,!0);for(let[e,t]of[[-24,-20],[22,-24],[-18,20],[24,16]])vp(Bf,`sparkle`,n,r,260,{"--dx":`${e}px`,"--dy":`${t}px`},`✦`);yp()}function Sp(){let e=++fp;zf.classList.remove(`hit`),Vf.classList.remove(`active`),zf.offsetWidth,zf.classList.add(`hit`),Wf.matches||Vf.classList.add(`active`),hp(()=>{e===fp&&(zf.classList.remove(`hit`),Vf.classList.remove(`active`))},440);let{x:t,y:n}=_p(new V($.x,$.y+.9,$.zOffset)),r=[`#8a4f2c`,`#d6b58b`,`#5b4336`];for(let e=0;e<10;e++)vp(Bf,`debris`,t,n,500,{"--dx":`${Math.round((Math.random()-.5)*110)}px`,"--dy":`${Math.round(-25-Math.random()*70)}px`,"--rot":`${Math.round((Math.random()-.5)*480)}deg`,"--color":r[e%r.length]})}function Cp(){If.classList.add(`fanfare`),Gd.best();let e=[`#c9502f`,`#ffe8c9`,`#7dff9b`,`#e8b23a`];for(let t=0;t<24;t++)vp(Uf,`confetti`,`${5+Math.random()*90}%`,`${Math.random()*12}%`,1200,{"--dx":`${Math.round((Math.random()-.5)*120)}px`,"--dy":`${Math.round(window.innerHeight*(.55+Math.random()*.35))}px`,"--rot":`${Math.round((Math.random()-.5)*900)}deg`,"--color":e[t%e.length]})}function wp(e){sp.add(e),ap=Math.min(3,ap+1);let t=ap*5;Xf+=t,kf.textContent=Math.floor(Xf),yp(),bp(`CLOSE ONE! +${t} · ×${ap}`),Gd.nearMiss()}function Tp(e){for(let e of sp)e.active||sp.delete(e);for(let[t,n]of op){if(n!==cp||!t.active){op.delete(t);continue}let r=t.type.sub?.map(e=>e.half.z+.52-e.dz)||[],i=Math.max(t.type.half.z+.52,...r);t.obj.position.z-e>i&&(op.delete(t),wp(t))}}function Ep(){jd(),Gd.stopLoops(),gp(),bf.reset(),xf.reset(),wf.reset(),Cf.reset(),$.reset(),Yf=Gf[Kf].base,Xf=0,Zf=0,$f=2,ap=0,ep=0,tp=0,ip=0,Df.visible=!1,Jf=`running`,Nf.classList.add(`hidden`),Pf.classList.add(`hidden`),Rf.textContent=``,kf.textContent=`0`,jf.textContent=`0`,Mf.textContent=String($f)}function Dp(){ep>0||$.flying>0||(--$f,Mf.textContent=String($f),ap=0,op.clear(),np=Wf.matches?0:.4,Sp(),Gd.hit(),$f>0?(ep=2.2,$.sliding=0,$.zOffset=-1.4,Df.visible=!0,Df.position.set($.x,0,2.6),Gd.bark()):Op())}function Op(){Jf=`over`,Gd.stopLoops();let e=Math.floor(Xf),t=e>Qf;Df.visible&&Gd.bark(),t||Gd.gameover(),rp=performance.now(),ip=Df.visible?.45:0,t&&(Qf=e,localStorage.setItem(`csr-best`,String(Qf))),Ff.textContent=e,Lf.textContent=`🪙 ${Zf} collected · +${Zf*qf} pts`,If.textContent=t?`NEW BEST!`:`Best: ${Math.floor(Qf)}`,If.className=t?`best-line new-best`:`best-line`,Af.textContent=Math.floor(Qf),Pf.classList.remove(`hidden`),t&&Cp(),Rp(e)}var kp=Of(`lb`),Ap=Of(`lbList`),jp=Of(`lbStatus`),Mp=Of(`lbForm`),Np=Of(`lbNameInput`),Pp=Of(`lbThisBtn`),Fp=Of(`lbLastBtn`),Ip=Of(`lbRenameBtn`),Lp=0;Yd()&&(kp.classList.remove(`hidden`),Pp.textContent=`🏆 ${af(0)}`,Fp.textContent=af(-1));async function Rp(e){if(Yd()){if(!$d()){Mp.classList.remove(`hidden`),Ip.classList.add(`hidden`),jp.textContent=`Pick a name to join the monthly leaderboard!`,Ap.innerHTML=``,Mp.dataset.pendingScore=String(e);return}try{await of(e)}catch{}zp()}}async function zp(){Mp.classList.add(`hidden`),Ip.classList.remove(`hidden`),jp.textContent=`Loading…`;try{let e=await cf(Lp),t=Zd();Ap.innerHTML=``,e.slice(0,10).forEach((e,n)=>{let r=document.createElement(`li`);e.player_id===t&&(r.className=`me`),r.innerHTML=`<span class="rank">${[`🥇`,`🥈`,`🥉`][n]||n+1}</span><span class="nm"></span><span class="sc"></span>`,r.querySelector(`.nm`).textContent=e.name,r.querySelector(`.sc`).textContent=e.score,Ap.appendChild(r)});let n=e.findIndex(e=>e.player_id===t);jp.textContent=e.length===0?`No scores yet this month — be the first!`:n>=0?`You're #${n+1} of ${e.length} this month`:``}catch{jp.textContent=`Leaderboard unavailable (offline?)`}}Of(`lbSaveBtn`).addEventListener(`click`,async()=>{let e=Np.value.trim();if(!e){Np.focus();return}Gd.click();let t=Number(Mp.dataset.pendingScore||0);Mp.dataset.pendingScore=``;try{await sf(e),t>0&&await of(t)}catch{}zp()}),Np.addEventListener(`keydown`,e=>{e.key===`Enter`&&Of(`lbSaveBtn`).click()}),Ip.addEventListener(`click`,()=>{Gd.click(),Np.value=$d(),Mp.classList.remove(`hidden`),Ip.classList.add(`hidden`),Np.focus()}),Pp.addEventListener(`click`,()=>{Lp=0,Pp.classList.add(`sel`),Fp.classList.remove(`sel`),zp()}),Fp.addEventListener(`click`,()=>{Lp=-1,Fp.classList.add(`sel`),Pp.classList.remove(`sel`),zp()}),Of(`startBtn`).addEventListener(`click`,Ep),Of(`restartBtn`).addEventListener(`click`,Ep),Of(`menuBtn`).addEventListener(`click`,()=>{jd(),Gd.click(),Gd.stopLoops(),gp(),Jf=`ready`,Df.visible=!1,$.reset(),Pf.classList.add(`hidden`),Nf.classList.remove(`hidden`)});var Bp=Of(`mute`);function Vp(){let e=Md();Bp.textContent=e?`🔇`:`🔊`,Bp.setAttribute(`aria-label`,e?`Turn sound on`:`Mute sound`),Bp.title=e?`Turn sound on`:`Mute sound`}Vp(),Bp.addEventListener(`click`,()=>{jd(),Nd(!Md()),Vp(),Md()||Gd.click()});var Hp=Of(`charRow`);for(let e of wd){let t=document.createElement(`button`);t.className=`chip`+(e.id===Sf.id?` sel`:``),t.textContent=`${e.emoji} ${e.name}`,t.addEventListener(`click`,()=>{Sf=e,Ed(e.id),$.setCharacter(e),Hp.querySelectorAll(`.chip`).forEach(e=>e.classList.remove(`sel`)),t.classList.add(`sel`)}),Hp.appendChild(t)}for(let e of[`easy`,`hard`]){let t=Of(e+`Btn`);t.classList.toggle(`sel`,Kf===e),t.addEventListener(`click`,()=>{Kf=e,localStorage.setItem(`csr-mode`,e),Of(`easyBtn`).classList.toggle(`sel`,e===`easy`),Of(`hardBtn`).classList.toggle(`sel`,e===`hard`)})}var Up=Of(`newsBtn`);function Wp(){Up.textContent=`📰 Local News: ${bu()?`On`:`Off`}`,Up.classList.toggle(`sel`,bu())}Wp(),Up.addEventListener(`click`,()=>{xu(!bu()),Wp()});function Gp(){Jf===`over`&&performance.now()-rp>700&&Ep()}od({left:()=>{Jf===`running`&&$.moveLane(-1)},right:()=>{Jf===`running`&&$.moveLane(1)},up:()=>{Jf===`running`?($.grounded&&$.flying<=0&&Gd.jump(),$.jump()):Gp()},down:()=>{Jf===`running`&&($.flying<=0&&Gd.slide(),$.slide())},anyKey:()=>Gp()}),window.addEventListener(`keydown`,e=>{e.target.closest?.(`input, textarea`)||e.code===`Space`&&Gp()});var Kp=new ja;function qp(){Jp(Math.min(Kp.getDelta(),.05),Kp.elapsedTime),uf.render(ff,pf),requestAnimationFrame(qp)}function Jp(e,t){if(pd(Ef,t),dd(Tf,t),Jf===`running`){let n=Gf[Kf];Yf=Math.min(n.max,Yf+n.accel*e);let r=Yf*e,i=(Yf-n.base)/(n.max-n.base);bf.update(r,e),xf.update(r,e,t,i),Cf.update(r,e,t);let a=$.flying>0;$.update(e,Yf),gf.offset.y+=r/_f,Xf+=r,kf.textContent=Math.floor(Xf),tp>0&&(tp-=e);let o=tp>0||$.flying>0,s=wf.update(r,e,t,$,o,xf),c=0,l=null;for(let e of s)if(e.cfg.power===`magnet`)tp=7,Gd.magnetPickup();else if(e.cfg.power===`fly`)$.startFlight(4.5),Gd.bonus(),Gd.jetpackPickup();else{let t=e.cfg.value*qf;Zf+=e.cfg.value,Xf+=t,c+=t,l||=e.obj.position.clone()}if(c>0&&(Gd.coin(),xp(c,l),kf.textContent=Math.floor(Xf)),a&&$.flying<=0&&Gd.jetpackEnd(),tp<=0&&tp>-e*2&&Gd.magnetEnd(),jf.textContent=Zf,Rf.textContent=$.flying>0?`🍦 ${$.flying.toFixed(1)}s`:tp>0?`🧲 ${tp.toFixed(1)}s`:``,ep>0&&(ep-=e,$.body.visible=Math.floor(t*12)%2==0,ep<=0&&($.body.visible=!0)),ep<=0&&$.flying<=0){let e=$.zOffset,t=xf.checkCollision($.x,$.bottom,$.top,.32,.3,e),n=bf.checkVehicleHit($.x,$.bottom,$.top,e);if(t||n)t&&op.delete(t),Dp();else{let t=xf.checkCollision($.x,$.bottom-.45,$.top+.55,.62,.52,e);t&&!sp.has(t)&&op.set(t,cp),Tp(e)}}Df.visible&&(Df.position.x+=($.x-Df.position.x)*Math.min(1,e*8),Df.position.z=$.zOffset+3+Math.sin(t*2.2)*.35,ql(Df,t,11))}else Jf===`ready`?$.update(e,6):Jf===`over`&&ip>0&&(ip-=e,Df.position.z+=($.zOffset+.4-Df.position.z)*Math.min(1,e*10),ql(Df,t,14));let n=$.group.position.x*.35,r=4.6;if(Jf===`running`&&(r+=Math.sin(t*9)*.03,$.flying>0&&(r+=$.y*.35)),np>0&&!Wf.matches){np-=e;let t=np*.5;n+=(Math.random()-.5)*t,r+=(Math.random()-.5)*t}else Wf.matches&&(np=0);pf.position.set(n,r,7.2),pf.lookAt(n*.6,2.2,-20)}qp(),window.addEventListener(`resize`,()=>{pf.aspect=window.innerWidth/window.innerHeight,pf.updateProjectionMatrix(),uf.setSize(window.innerWidth,window.innerHeight)}),window.__csr={start:Ep,step:(e=1/60,t=0)=>Jp(e,t),get state(){return Jf},get score(){return Math.floor(Xf)},get speed(){return Yf},get lives(){return $f},get coins(){return Zf},get nearMissStreak(){return ap},set mode(e){Kf=e},player:$,obstacles:xf,chunks:bf,collectibles:wf};